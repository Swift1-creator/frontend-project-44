...
, function (err, res, pkg) {
    ...
    resolve('./foo', { basedir: dir, 'package': { main: 'resolver' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'foo.js'))
    ...
    resolve('./foo', { basedir: dir, filename: path.join(dir, 'baz.js') }
, function (err, res) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'foo.js'))
    }
...
, function (err, res, pkg) {
    ...
    resolve('foo', { basedir: dir + '/bar', 'package': { main: 'bar' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'bar/node_modules/foo/index.js'))
...
, function (err, res, pkg) {
    ...
    resolve('./grux', { basedir: dir, 'package': { main: 'biz' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'grux/index.js'))
...
, function (err, res, pkg) {
    ...
    resolve('./garply', { basedir: dir, 'package': { main: 'biz' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'garply/lib/index.js'))
        t.equal(pkg.main, './lib')
...
, function (err, res, pkg) {
    ...
    resolve('tiv', { basedir: dir + '/grux', 'package': { main: 'grux' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'tiv/index.js'))
    ...
    resolve('tiv', { basedir: dir + '/garply' }
, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'tiv/index.js'))
        t.equal(pkg, undefined)
    ...
    resolve('tiv', { basedir: dir + '/garply', 'package': { main: './lib' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'tiv/index.js'))
        t.equal(pkg.main, './lib')
...
, function (err, res, pkg) {
    ...
    resolve('grux', { basedir: dir + '/tiv', 'package': { main: 'tiv' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'grux/index.js'))
    ...
    resolve('garply', { basedir: dir + '/tiv' }
, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'garply/lib/index.js'))
        t.equal(pkg.main, './lib')
    ...
    resolve('garply', { basedir: dir + '/tiv', 'package': { main: 'tiv' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'garply/lib/index.js'))
        t.equal(pkg.main, './lib')
...
test('quux', function (t) {
    ...
    resolve('./foo', { basedir: dir, 'package': { main: 'quux' }
}, function (err, res, pkg) {
        if (err) t.fail(err)
...
test('other path', function (t) {
    ...
    resolve('root', { basedir: dir, paths: [otherDir] }
, function (err, res) {
        if (err) t.fail(err)
...
test('empty main', function (t) {
    ...
    resolve('./empty_main', { basedir: resolverDir }
, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'index.js'))
    }
...
test('missing index', function (t) {
    ...
    var resolverDir = path.join(__dirname, 'resolver')
    resolve('./missing_index', { basedir: resolverDir }
, function (err, res, pkg) {
...
test('missing main', function (t) {
    ...
    resolve('./missing_main', { basedir: resolverDir }
, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'index.js'))
    }
...
test('null main', function (t) {
    ...
    resolve('./null_main', { basedir: resolverDir }
, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'index.js'))
    }
...
test('main: false', function (t) {
    ...
    resolve('./false_main', { basedir: basedir }
, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(
            res,
...
test('#211 - incorrectly resolves module-paths like "." when from inside a folder with a sibling file of the same name', function (t) {
    ...
    resolve('./', { basedir: path.join(dir, 'same_names/foo') }
, function (err, res, pkg) {
        if (err) t.fail(err)
        t.equal(res, path.join(dir, 'same_names/foo/index.js'))
    }
...
test('non-string "main" field in package.json', function (t) {
    ...
    var dir = path.join(__dirname, 'resolver')
    resolve('./invalid_main', { basedir: dir }
, function (err, res, pkg) {
...
test('absolute paths', function (t) {
    ...
    resolve(__filename, { basedir: process.cwd() }
, function (err, res) {
        t.equal(
            res,
            __filename,
    ...
    resolve(extensionless, { basedir: process.cwd() }
, function (err, res) {
        t.equal(
            res,
            __filename,
...
test('malformed package.json', { skip: !fs.existsSync(malformedDir) }
, function (t) {
    ...
    resolve('./index.js', { basedir: basedir }
, function (err, res, pkg) {
