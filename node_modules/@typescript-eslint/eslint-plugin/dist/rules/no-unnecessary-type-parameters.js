...
,
        ...
        messages: {
            ...
            sole: 'Type parameter {{name}
} is {{uses}} in the {{descriptor}} signature.',
        }
,
        schema: [],
    }
...
/**
 * Populates {@link foundIdentifierUsages}
by the number of times each type parameter
        ...
        // generic interface/class, e.g. `Map<K, V>`.
            ...
            if (isMappedType(type)) {
                ...
                if (properties.length === 0) {
                    // TS treats mapped types like `{[k in "a"]: T}
` like `{a: T}`.
