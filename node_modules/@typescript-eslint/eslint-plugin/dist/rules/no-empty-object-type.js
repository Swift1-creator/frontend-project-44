...
allows any non-nullish value, including literals like \`0\` and \`""\`.`,
    "- If that's what you want, disable this lint rule with an inline comment or configure the '{{ option }
}' rule option.",
...
,
        ...
        messages: {
            ...
            noEmptyObject: noEmptyMessage('The `{}
` ("empty object") type'),
            ...
            replaceEmptyObjectType: 'Replace `{}
` with `{{replacement}}`.',
        }
,
        schema: [
...
,
                                    fix(fixer) {
                                        ...
                                        const typeParam = node.typeParameters
                                            ...
                                            : ''
                                        return fixer.replaceText(node, `type ${id}
${typeParam} = ${replacement}`)
                                    }
,
                                }
)),
