...
,
        ...
        hasSuggestions: true,
        messages: {
            addExplicitAccessibility: "Add '{{ type }
}' accessibility modifier",
            missingAccessibility: 'Missing accessibility modifier on {{type}
} {{name}}.',
            unwantedPublicAccessibility: 'Public accessibility modifier on {{type}
} {{name}}.',
        }
,
        schema: [
...
let nodeType = 'method definition'
            ...
            switch (methodDefinition.kind) {
                ...
                case 'set':
                    check = accessorCheck
                    nodeType = `${methodDefinition.kind}
property accessor`
                    break
            }
...
= (0, util_1.getNameFromMember)(propertyDefinition, context.sourceCode)
