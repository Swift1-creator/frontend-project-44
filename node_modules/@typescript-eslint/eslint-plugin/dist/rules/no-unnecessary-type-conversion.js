...
,
        ...
        messages: {
            ...
            suggestSatisfies: 'Instead, assert that the value satisfies the {{type}
} type.',
            unnecessaryTypeConversion: '{{violation}
} does not change the type or value of the {{type}}.',
        }
,
        schema: [],
    }
...
const typeString = nodeCallee.name.toLowerCase()
                context.report({
                    ...
                    data: {
                        ...
                        violation: `Passing a ${typeString}
to ${nodeCallee.name}()`,
                    }
,
                    suggest: [
