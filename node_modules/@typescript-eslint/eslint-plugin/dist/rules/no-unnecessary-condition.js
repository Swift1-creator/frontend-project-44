...
/**
 * Note that this differs from {@link isNullableType}
in that it doesn't consider
...
,
        ...
        messages: {
            ...
            comparisonBetweenLiteralTypes: 'Unnecessary conditional, comparison is always {{trueOrFalse}
}, since `{{left}} {{operator}} {{right}}` is {{trueOrFalse}}.',
...
= (0, util_1.getConstraintInfo)(checker, type)
