...
// There were no existing cases.
            ...
            const closingBrace = (0, util_1.nullThrows)(context.sourceCode.getTokenAfter(node.discriminant, util_1.isClosingBraceToken), util_1.NullThrowsReasons.MissingToken('}
', 'discriminant'))
            return fixer.replaceTextRange([openingBrace.range[0], closingBrace.range[1]], ['{', fixString, `${caseIndent}
}`].join('\n'))
        }
 ...
 * - `"foo" & { bar: 1 }
` is a type that contains non-literal types.
 *
