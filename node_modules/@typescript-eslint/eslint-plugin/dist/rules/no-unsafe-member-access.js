...
,
        messages: {
            unsafeComputedMemberAccess: 'Computed name {{property}
} resolves to an {{type}} value.',
            unsafeMemberExpression: 'Unsafe member access {{property}
} on an {{type}} value.',
            unsafeThisMemberExpression: [
                'Unsafe member access {{property}
} on an `any` value. `this` is typed as `any`.',
            ...
            if (state === State.Unsafe) {
                ...
                context.report({
                    ...
                    data: {
                        ...
                        property: node.computed ? `[${propertyName}
]` : `.${propertyName}`,
                    }
,
                }
