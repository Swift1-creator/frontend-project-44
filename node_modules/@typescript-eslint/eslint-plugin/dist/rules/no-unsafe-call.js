...
,
        messages: {
            unsafeCall: 'Unsafe call of a(n) {{type}
} typed value.',
            unsafeCallThis: [
                'Unsafe call of a(n) {{type}
} typed value. `this` is typed as {{type}}.',
                'You can try to fix this by turning on the `noImplicitThis` compiler option, or adding a `this` parameter to the function.',
            ].join('\n'),
            unsafeNew: 'Unsafe construction of a(n) {{type}
} typed value.',
            unsafeTemplateTag: 'Unsafe use of a(n) {{type}
} typed template tag.',
        }
,
        schema: [],
