...
const scope = context.sourceCode.getScope(node)
            const smVariable = (0, util_1.nullThrows)((0, util_1.findVariable)(scope, node), `Variable ${node.name}
should exist in scope manager`)
...
// promise.catch(x => { throw x; })
            ...
            if (def.node.type === utils_1.AST_NODE_TYPES.ArrowFunctionExpression &&
                ...
                if (parsedPromiseHandlingCall != null) {
                    const { object, onRejected }
= parsedPromiseHandlingCall
