 ...
 */
function isValidFunctionReturnType({ node, returns }
, options) {
 ...
 */
function checkFunctionReturnType({ node, returns }
, options, sourceCode, report) {
    if (isValidFunctionReturnType({ node, returns }
, options)) {
        return
    }
