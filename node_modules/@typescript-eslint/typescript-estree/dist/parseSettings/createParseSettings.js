    ...
    const tsconfigRootDir = (() => {
        if (tsestreeOptions.tsconfigRootDir == null) {
            ...
            if (node_path_1.default.resolve(inferredTsconfigRootDir) !== inferredTsconfigRootDir) {
                throw new Error(`inferred tsconfigRootDir should be a resolved absolute path, but received: ${JSON.stringify(inferredTsconfigRootDir)}
...
if (typeof tsestreeOptions.tsconfigRootDir === 'string') {
            ...
            if (!node_path_1.default.isAbsolute(userProvidedTsconfigRootDir) ||
                ...
                throw new Error(`parserOptions.tsconfigRootDir must be an absolute path, but received: ${JSON.stringify(userProvidedTsconfigRootDir)}
