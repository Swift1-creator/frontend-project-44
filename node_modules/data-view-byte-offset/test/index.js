...
test('dataViewByteOffset', function (t) {
	forEach(
		...
		/** @type {[...typeof v.primitives, ...typeof v.objects]}
*/ ([].concat(v.primitives, v.objects)),
		function (nonDV) {
			t['throws'](function () { dataViewByteOffset(nonDV); }
, TypeError, inspect(nonDV) + ' is not a DataView')
		}
)

	t.test('DataView', { skip: typeof DataView !== 'function' }
, function (st) {
