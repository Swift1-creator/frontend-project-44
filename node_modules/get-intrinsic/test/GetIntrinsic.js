...
test('dotted paths', function (t) {
	...
	test('underscore paths are aliases for dotted paths', { skip: !Object.isFrozen || Object.isFrozen(Object.prototype) }
, function (st) {
	...
	test('dotted paths cache', { skip: !Object.isFrozen || Object.isFrozen(Object.prototype) }
, function (st) {
...
test('accessors', { skip: !$gOPD || typeof Map !== 'function' }
, function (t) {
...
test('generator functions', { skip: !generatorFns.length }
, function (t) {
...
test('async functions', { skip: !asyncFns.length }
, function (t) {
...
test('async generator functions', { skip: asyncGenFns.length === 0 }
, function (t) {
...
test('allowMissing', { skip: asyncGenFns.length > 0 }
, function (t) {
	t['throws'](
