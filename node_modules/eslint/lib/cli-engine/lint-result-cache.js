 ...
 * @param {string}
cacheStrategy The cache strategy to use
 * @returns {boolean}
true if `cacheStrategy` is one of `validCacheStrategies`; false otherwise
 */
...
function hashOfConfigFor(config) {
	if (!configHashCache.has(config)) {
		configHashCache.set(
			config,
			hash(`${pkg.version}
_${nodeVersion}_${stringify(config)}`),
		)
	}
...
class LintResultCache {
	 ...
	 * @param {string}
cacheFileLocation The cache file location.
...
`)
		...
		debug(`Using "${cacheStrategy}
" strategy to detect changes`)
...
config The config of the file.
	 * @returns {Object|null}
The rebuilt lint results, or null if the file is
...
config The config of the file.
	 * @returns {Object|null}
The cached lint results if present in the cache
...
/**
	 ...
	 * written to disk.
	 * @param {string}
filePath The file for which to set lint results.
	 * @param {Config}
config The config of the file.
	 * @param {Object}
result The lint result to be set for the file.
	 * @returns {void}
*/
