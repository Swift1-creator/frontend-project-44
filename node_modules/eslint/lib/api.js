...
const { ESLint, shouldUseFlatConfig }
= require("./eslint/eslint")
const { LegacyESLint }
= require("./eslint/legacy-eslint")
const { Linter }
= require("./linter")
const { RuleTester }
= require("./rule-tester")
 ...
 * @param {boolean}
[options.useFlatConfig] Whether or not to use a flat config
 * @returns {Promise<ESLint|LegacyESLint>}
