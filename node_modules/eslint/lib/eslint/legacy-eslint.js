 ...
 * @property {(results: LintResult[], resultsMeta: ResultsMeta) => string | Promise<string>}
 ...
 * @property {ConfigData}
[baseConfig] Base config object, extended by all configs used with this instance
 * @property {boolean}
 ...
 * @property {ConfigData}
[overrideConfig] Override config object, overrides all configs used with this instance
 * @property {string}
[overrideConfigFile] The configuration file to use.
 * @property {Record<string,Plugin>|null}
[plugins] Preloaded plugins. This is a map-like object, keys are plugin IDs and each value is implementation.
 * @property {"error" | "warn" | "off"}
[reportUnusedDisableDirectives] the severity to report unused eslint-disable directives.
 * @property {string}
...
id The plugin ID.
 * @property {Object}
definition The plugin definition.
 */

/**
 * Private members for the `ESLint` instance.
 * @typedef {Object}
ESLintPrivateMembers
 * @property {CLIEngine}
cliEngine The wrapped CLIEngine instance.
 * @property {LegacyESLintOptions}
options The options used to instantiate the ESLint instance.
 */
...
value The value to check.
 * @returns {boolean}
`true` if `value` is valid fix type.
 */
...
value The value to check.
 * @returns {boolean}
`true` if `value` is an array of fix types.
 */
 ...
 * @returns {boolean}
`true` if `obj` has one or more properties that value is not undefined.
 */
 ...
 * @param {CLIEngine}
cliEngine The CLIEngine instance.
 * @param {string}
 ...
 * @param {CLIEngine}
cliEngine The CLIEngine instance.
 * @param {CLIEngineLintReport}
report The CLIEngine linting report to process.
 * @returns {LintResult[]}
...
[name] The name of the formatter to load.
	 ...
	 * @returns {Promise<LoadedFormatter>}
...
module.exports = {
	 ...
	 * @param {ESLint}
instance The ESLint instance to get.
	 * @returns {ESLintPrivateMembers}
The instance's private class members.
	 */
