...
const { ConfigArray, ConfigArraySymbol }
 ...
 * @param {number}
originalLength The original length of the config array.
 * @param {number}
baseLength The length of the base config.
 * @returns {TypeError}
...
class FlatConfigArray extends ConfigArray {
	 ...
	 * @param {*[]}
configs An array of configuration information.
	 * @param {{basePath: string, shouldIgnore: boolean, baseConfig: FlatConfig}
} options The options
...
/**
	 ...
	 * @param {any}
[context] The context to use to normalize the array.
	 * @returns {Promise<FlatConfigArray>}
A promise that resolves when the array is normalized.
	 */
	normalize(context) {
