...
class WarningService {
	 ...
	 * @param {{ emitWarning?: ((warning: string, type: string) => void) | undefined }
} [options] A function called internally to emit warnings using API provided by the runtime.
	 */
	constructor({
...
*/
	emitCircularFixesWarning(filename) {
		this.emitWarning(
			`Circular fixes detected while fixing ${filename}
...
). Please double-check that this is what you want. If you want to run ESLint with an empty config, export [{}] to remove this warning.`,
...
/**
	 ...
	 * @param {string}
notice A notice about how to improve performance.
	 * @returns {void}
*/
