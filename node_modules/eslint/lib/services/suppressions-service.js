...
LintResult */
/** @typedef {Record<string, Record<string, { count: number; }
...
options The options.
	 * @param {string}
[options.filePath] The location of the suppressions file.
	 * @param {string}
...
/**
	 ...
	 * @param {LintResult[]|undefined}
results The lint results.
	 * @param {string[]|undefined}
rules The rules to suppress.
...
No return value.
	...
	async prune(results) {
		const suppressions = await this.load()
		const { unused }
= this.applySuppressions(results, suppressions)
...
/**
	 ...
	 * @param {LintResult[]}
results The lint results.
	 * @param {SuppressedViolations}
suppressions The suppressions.
	 * @returns {{
	 *   results: LintResult[],
...
// Recalculate stats if messages were suppressed
	 ...
	 * @throws {Error}
If the suppressions file cannot be parsed.
	 * @returns {Promise<SuppressedViolations>}
The suppressions.
	 */
	async load() {
		try {
...
The number of violations by rule.
	 */
