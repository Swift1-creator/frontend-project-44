 ...
 * display the data
 * @param {Object}
data Data object to be displayed
 * @returns {void}
prints modified string with console.log
 * @private
 */
...
fn function to be called
	 * @param {boolean}
stats if 'stats' is true, return the result and the time difference
	 * @returns {Function}
...
mapping of ruleId to total time in ms
	 */
	function getData() {
		return { ...data }
}
...
dataToMerge mapping of ruleId to total time in ms
	 * @returns {void}
*/
