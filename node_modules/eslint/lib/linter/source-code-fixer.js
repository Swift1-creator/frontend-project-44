 ...
 * @param {string}
sourceText The text to apply the changes to.
 * @param {Message[]}
messages The array of messages reported by ESLint.
 * @param {boolean|Function}
[shouldFix=true] Determines whether each message should be fixed
 * @returns {Object}
...
SourceCodeFixer.applyFixes = function (sourceText, messages, shouldFix) {
	 ...
	 * @param {Message}
problem The message object to apply fixes from
	 * @returns {boolean}
