 ...
 * @returns {boolean}
`true` if the segment is reachable.
 */
 ...
 * `b`, `d`, and `f`.
 * @param {ForkContext}
context An instance from which the previous segments
 *      will be obtained.
 * @param {number}
startIndex The index of the first segment in the context
 *      that should be specified as previous segments for the newly created segments.
 * @param {number}
endIndex The index of the last segment in the context
 *      that should be specified as previous segments for the newly created segments.
 * @param {Function}
create A function that creates new `CodePathSegment`
 *      instances in a particular way. See the `CodePathSegment.new*` methods.
 * @returns {Array<CodePathSegment>}
An array of the newly-created segments.
 */
 ...
 * @param {ForkContext}
context The fork context to work on.
 * @param {Array<CodePathSegment>}
...
class ForkContext {
	 ...
	 * @param {IdGenerator}
idGenerator An identifier generator for segments.
	 * @param {ForkContext|null}
upper The preceding fork context.
	 * @param {number}
count The number of parallel segments in each element
	 *      of `segmentsList`.
	 */
...
/**
	 ...
	 * @param {Array<CodePathSegment>}
replacementHeadSegments The new head segments.
	 * @returns {void}
*/
	replaceHead(replacementHeadSegments) {
		assert(
			replacementHeadSegments.length >= this.count,
			`${replacementHeadSegments.length}
>= ${this.count}`,
		)
...
/**
	 ...
	 * @param {ForkContext}
otherForkContext The fork context to add from.
	 * @returns {void}
*/
...
/**
	 ...
	 * @param {ForkContext}
parentContext The parent fork context.
	 * @param {boolean}
shouldForkLeavingPath Indicates that we are inside of
