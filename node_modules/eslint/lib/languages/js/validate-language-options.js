 ...
 * @param {string|number}
ecmaVersion The value to check.
 * @returns {void}
 ...
 * @param {Object}
languageOptions The language options to validate.
 * @returns {void}
...
if ("parserOptions" in languageOptions) {
	...
	if (otherOptionKeys.length > 0) {
		throw new TypeError(`Unexpected key "${otherOptionKeys[0]}
" found.`)
	}
}
