...
const { getCacheFile }
= require("./eslint/eslint-helpers")
const { SuppressionsService }
= require("./services/suppressions-service")
 ...
 * @param {ESLint}
engine The ESLint instance to use.
 * @param {LintResult[]}
results The results to print.
 * @param {string}
format The name of the formatter to use or the path to the formatter.
 * @param {string}
outputFile The path for the output file.
 * @param {ResultsMeta}
resultsMeta Warning count and max threshold.
 * @returns {Promise<boolean>}
True if the printing succeeds, false if not.
 * @private
 */
 ...
 * @param {string}
concurrency The `--concurrency` flag value to validate.
 * @returns {void}
...
' is not a positive integer, 'auto' or 'off'.`,
		)
	}
}
...
const cli = {
	 ...
	 * @param {string}
configFile The path to the config file to inspect.
...
args The arguments to process.
	 * @param {string}
[text] The text to lint (used for TTY).
	 * @param {boolean}
[allowFlatConfig=true] Whether or not to allow flat config.
