...
,
		...
		messages: {
			preferReflect:
				"Avoid using {{existing}
}, instead use {{substitute}}.",
		}
,
	}
,
...
const exceptions = (context.options[0] || {}).exceptions || []
		 ...
		 * @param {Object}
node The node that violates the rule.
		 * @param {string}
existing The existing method name that has been used.
		 * @param {string}
substitute The Reflect substitute that should be used.
		 * @returns {void}
*/
