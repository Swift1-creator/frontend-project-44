...
node node to check
		 * @returns {boolean}
True if its an instance method
		 * @private
		 */
...
node node to check
		 * @returns {boolean}
True if parent class implements interfaces
		 * @private
		 */
...
node node to check
		 * @returns {boolean}
True if it is an instance method, and not excluded by config
		 * @private
		 */
...
/**
		 ...
		 * @param {ASTNode}
node A function node that was entered.
		 * @returns {void}
* @private
		 */
