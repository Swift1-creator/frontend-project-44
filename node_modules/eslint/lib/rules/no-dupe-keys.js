...
class ObjectInfo {
	/**
	 * @param {ObjectInfo|null}
upper The information of the outer object.
	 * @param {ASTNode}
node The ObjectExpression node of this information.
	 */
...
/**
	 ...
	 * @param {ASTNode}
node The Property node to get.
	 * @returns {{get: boolean, set: boolean}
...
node The Property node to check.
	 * @returns {boolean}
`true` if the property has been defined.
	 */
...
/**
	 ...
	 * @param {ASTNode}
node The Property node to define.
	 * @returns {void}
*/
	defineProperty(node) {
		const entry = this.getPropertyInfo(node)
