...
,
	...
	create(context) {
		const [{ allow: allowed, int32Hint }
] = context.options

		/**
		 * Reports an unexpected use of a bitwise operator.
		 * @param {ASTNode}
node Node which contains the bitwise operator.
		 * @returns {void}
*/
...
node The node to check.
		 * @returns {boolean}
Whether or not the node has a bitwise operator.
		 */
...
node The node to check.
		 * @returns {boolean}
whether the node is used in integer typecasting.
		 */
