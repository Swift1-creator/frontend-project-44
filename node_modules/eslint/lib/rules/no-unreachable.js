 ...
 * @param {ASTNode}
node A VariableDeclarator node to check.
 * @returns {boolean}
`true` if the node has the initializer.
 */
 ...
 * @returns {boolean}
True if all segments are unreachable; false otherwise.
 */
...
node The node to check.
	 * @returns {boolean}
`true` if the node is inside of this range.
	 */
	contains(node) {
		return (
...
node The node to check.
	 * @returns {boolean}
`true` if the node is consecutive to this range.
	 */
	isConsecutive(node) {
...
/**
	 ...
	 * @param {ASTNode|null}
node The node to reset, or null.
	 * @returns {void}
*/
	reset(node) {
...
*/
		 ...
		 * @param {ASTNode}
node A statement node to report.
		 * @returns {void}
*/
