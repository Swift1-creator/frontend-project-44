...
}' and instead saw '{{actualOperator}}'.",
			replaceOperator:
				"Use '{{expectedOperator}
}' instead of '{{actualOperator}}'.",
		}
,
	}
,
...
node The node to check
		 * @returns {boolean}
if the node is a typeof expression
		 */
...
node The node to check
		 * @returns {boolean}
if one of the operands is typeof
		 * @private
		 */
...
/**
		 ...
		 * @param {ASTNode}
node The binary expression node that was checked
		 * @param {string}
expectedOperator The operator that was expected (either '==', '!=', '===', or '!==')
		 * @returns {void}
* @private
		 */
