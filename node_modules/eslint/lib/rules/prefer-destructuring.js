...
//--------------------------------------------------------------------------
		 ...
		 * @param {string}
nodeType "AssignmentExpression" or "VariableDeclarator"
		 * @param {string}
destructuringType "array" or "object"
		 * @returns {boolean}
`true` if the destructuring type should be checked for the given node
		 */
...
node the node to evaluate
		 * @returns {boolean}
whether or not the node is an integer
		 */
...
/**
		 ...
		 * @param {ASTNode}
reportNode the node to report
		 * @param {string}
type the type of destructuring that should have been done
		 * @param {Function|null}
fix the fix function or null to pass to context.report
		 * @returns {void}
*/
...
node the node to evaluate
		 * @returns {boolean}
whether or not the node should be fixed
		 */
...
/**
		 ...
		 * @param {ASTNode}
leftNode the left-hand side of the assignment
		 * @param {ASTNode}
rightNode the right-hand side of the assignment
		 * @param {ASTNode}
reportNode the node to report the error on
		 * @returns {void}
*/
...
/**
		 ...
		 * @param {ASTNode}
node the variable declarator to check
		 * @returns {void}
*/
...
/**
		 ...
		 * @param {ASTNode}
node the AssignmentExpression node
		 * @returns {void}
*/
