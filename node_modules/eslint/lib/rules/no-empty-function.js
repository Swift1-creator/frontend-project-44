 ...
 * @param {ASTNode}
node A function node to get. This is one of
 *      an ArrowFunctionExpression, a FunctionDeclaration, or a
 *      FunctionExpression.
 * @returns {string}
The kind of the function. This is one of "functions",
 ...
 * @returns {boolean}
True if the constructor has parameter properties, false otherwise.
 */
...
node The function node to check.
		 * @returns {boolean}
True if the function is allowed to be empty, false otherwise.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node A function node to report. This is one of
		 *      an ArrowFunctionExpression, a FunctionDeclaration, or a
		 *      FunctionExpression.
		 * @returns {void}
*/
