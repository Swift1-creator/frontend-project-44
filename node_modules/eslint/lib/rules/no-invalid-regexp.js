...
,
	...
	create(context) {
		 ...
		 * @param {ASTNode}
node The node holding the invalid RegExp
		 * @param {string}
...
/**
		 ...
		 * @param {ASTNode}
node `CallExpression` or `NewExpression` node
		 * @returns {string|null}
flags if they can be determined, `null` otherwise
		 * @private
		 */
...
/**
		 ...
		 * @param {string}
pattern The RegExp pattern to validate.
		 * @param {Object}
flags The RegExp flags to validate.
		 * @param {boolean}
[flags.unicode] The Unicode flag.
		 * @param {boolean}
[flags.unicodeSets] The UnicodeSets flag.
		 * @returns {string|null}
The syntax error.
		 */
...
flags The RegExp flags to validate.
		 * @param {string|null}
flagsToCheck The RegExp invalid flags.
		 * @param {string}
allFlags all valid and allowed flags.
		 * @returns {string|null}
The syntax error.
		 */
...
if (duplicateFlags.length > 0) {
				return `Duplicate flags ('${duplicateFlags.join("")}
') supplied to RegExp constructor`
			}
if (!flagsToCheck) {
				return null
			}
