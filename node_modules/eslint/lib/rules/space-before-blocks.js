 ...
 * @returns {boolean}
`true` if the node is function body.
 */
...
/**
		 ...
		 * @param {Token}
precedingToken first token before the block.
		 * @param {ASTNode|Token}
node `BlockStatement` node or `{` token of a `SwitchStatement` node.
		 * @returns {boolean}
`true` if requiring or disallowing spaces before the given block could produce conflicts with other rules.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node The node of a SwitchStatement.
		 * @returns {void}
undefined.
		 */
