...
,
		...
		messages: {
			...
			maxComment:
				"This line has a comment length of {{lineLength}
...
line The line.
		 * @param {number}
tabWidth The width of each tab stop in spaces.
		 * @returns {number}
The computed line length.
		 * @private
		 */
...
//--------------------------------------------------------------------------
		 ...
		 * @param {string}
line The source line we want to check for a trailing comment on
		 * @param {number}
lineNumber The one-indexed line number for line
		 * @param {ASTNode}
comment The comment to inspect
		 * @returns {boolean}
If the comment is trailing on the given line
		 */
...
/**
		 ...
		 * @param {string}
line The source line with a trailing comment
		 * @param {number}
lineNumber The one-indexed line number this is on
		 * @param {ASTNode}
comment The comment to remove
		 * @returns {boolean}
If the comment covers the entire line
		 */
...
node A node to check.
		 * @returns {boolean}
True if the node is a JSXEmptyExpression contained in a single line JSXExpressionContainer.
		 */
...
comment The comment to remove
		 * @returns {string}
Line without comment and trailing whitespace
		 */
...
/**
		 ...
		 * @returns {ASTNode[]}
An array of template literal nodes.
		 */
...
/**
		 ...
		 * @returns {ASTNode[]}
An array of RegExp literal nodes.
		 */
...
/**
		 ...
		 * @param {ASTNode[]}
arr array of AST nodes
		 * @returns {Object}
accululated AST nodes
		 */
