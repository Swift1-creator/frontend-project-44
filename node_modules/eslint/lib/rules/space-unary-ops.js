...
node AST node
		 * @returns {boolean}
Whether or not the node is first "!" in "!!"
		 */
...
operator Operator
		 * @returns {boolean}
Whether or not an override has been provided for the operator
		 */
...
operator Operator
		 * @returns {boolean}
Whether or not an override enforces a space with this operator
		 */
...
node AST node
		 * @param {Object}
firstToken first token from the AST node
		 * @param {Object}
secondToken second token from the AST node
		 * @param {string}
word The word to be used for reporting
		 * @returns {void}
*/
...
node AST node
		 * @param {Object}
firstToken First token in the expression
		 * @param {Object}
secondToken Second token in the expression
		 * @returns {void}
*/
