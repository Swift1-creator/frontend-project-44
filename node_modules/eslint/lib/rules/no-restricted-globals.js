...
,
		...
		messages: {
			...
			customMessage: "Unexpected use of '{{name}
}'. {{customMessage}}",
		}
,
	}
...
,
		 ...
		 * @param {Reference}
reference the variable reference
		 * @returns {void}
* @private
		 */
...
name name of a variable
		 * @returns {boolean}
whether the variable is a restricted global or not
		 * @private
		 */
...
/**
		 ...
		 * @param {Reference}
reference The variable reference to check.
		 * @returns {boolean}
Whether the reference is in a type context.
		 * @private
		 */
