 ...
 * @param {Token[]}
left First list of tokens.
 * @param {Token[]}
right Second list of tokens.
 * @returns {boolean}
`true` if the lists have same tokens.
 */
 ...
 * @returns {boolean}
`true` if the node is of an accessor kind.
 */
...
node A node to check.
 * @param {number}
index An expected index of the node in arguments.
 * @param {string}
object An expected name of the object of the method.
 * @param {string}
property An expected name of the method.
 * @returns {boolean}
`true` if the node is an argument of the specified method call.
 */
...
node A node to check.
 * @returns {boolean}
`true` if the node is a property descriptor.
 */
...
node The node to report.
		 * @param {string}
messageKind "missingGetter" or "missingSetter".
		 * @returns {void}
* @private
		 */
...
/**
		 ...
		 * @param {ASTNode}
node Property descriptor `ObjectExpression` node to check.
		 * @returns {void}
* @private
		 */
...
/**
		 ...
		 * @param {ASTNode}
node `TSTypeLiteral` or `TSInterfaceBody` node to check.
		 * @returns {void}
* @private
		 */
