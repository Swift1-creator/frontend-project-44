...
,
		...
		messages: {
			restrictedObjectProperty:
				...
				"'{{objectName}
}.{{propertyName}}' is restricted from being used.{{allowedPropertiesMessage}}{{message}}",
			restrictedProperty:
				// eslint-disable-next-line eslint-plugin/report-message-format -- Custom message might not end in a period
				"'{{propertyName}
}' is restricted from being used.{{allowedObjectsMessage}}{{message}}",
		}
,
	}
,
...
name The name to check
		 * @param {string[]}
[allowedList] The list of allowed names
		 * @returns {boolean}
...
' is only allowed on these objects: ${globalMatchedProperty.allowObjects.join(", ")}.`
					: ""
