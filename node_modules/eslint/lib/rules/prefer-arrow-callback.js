 ...
 * @returns {boolean}
`true` if the variable is a function name.
 */
 ...
 * @param {ASTNode}
node A MetaProperty node to check.
 * @param {string}
metaName The name of `MetaProperty.meta`.
 * @param {string}
propertyName The name of `MetaProperty.property`.
 * @returns {boolean}
`true` if the node is the specific value.
 */
...
scope A scope to get.
 * @returns {eslint-scope.Variable}
The found variable object.
 */
 ...
 *   {boolean}
retv.isLexicalThis - `true` if the node is with `.bind(this)`.
 */
 ...
 * @param {ASTNode[]}
paramsList The list of parameters for a function
 * @returns {boolean}
`true` if the list of parameters contains any duplicates
 */
...
,
	...
	create(context) {
		const [{ allowNamedFunctions, allowUnboundThis }
] = context.options
...
/**
		 ...
		 * @returns {{this: boolean, super: boolean, meta: boolean}
} The information of the last scope.
		 */
		function exitScope() {
			return stack.pop()
		}
...
/*
							 ...
							 * the arrow function needs to be parenthesized, because `foo || () => {}
` is invalid syntax even
							 * though `foo || function() {}
` is valid.
							 */
							if (
