 ...
 * @returns {boolean}
Whether or not the name is prohibited.
 */
...
Returns the found reference or null if none were found.
 */
 ...
 * @returns {boolean}
Whether or not the name is shadowed.
 */
...
node The identifier node to check
 * @returns {boolean}
Whether or not the node is a reference to the global object.
 */
