...
node Node to check.
 * @returns {boolean}
True if the node is a regex literal.
 */
...
node Node to check.
		 * @returns {boolean}
True if the node is String.raw`` with a static template.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node The node to get the string of.
		 * @returns {string|null}
...
node Node to check.
		 * @returns {boolean}
True if the node is a static string.
		 */
...
node Node to check.
		 * @returns {boolean}
True if all arguments are static strings.
		 */
...
node Node to check.
		 * @returns {boolean}
True if the node already contains a regex literal argument.
		 */
...
/**
		 ...
		 * @param {number}
ecmaVersion The ecmaVersion to convert.
		 * @returns {import("@eslint-community/regexpp/ecma-versions").EcmaVersion}
The resulting ecmaVersion compatible for regexpp.
		 */
...
character The character to escape.
		 * @returns {string}
The resulting escaped character.
		 */
...
flags The regex flags to check.
		 * @returns {boolean}
True if the given regex pattern and flags are valid for the ecma version.
		 */
...
return true
		 ...
		 * @param {string}
flagsA The regex flags.
		 * @param {string}
flagsB The regex flags.
		 * @returns {boolean}
True if two regex flags contain same flags.
		 */
...
flags The regex flags
		 * @returns {boolean}
True if a node can be fixed to the given regex pattern and flags.
		 */
...
node The regex node.
		 * @param {string}
newRegExpValue The new regex expression value.
		 * @returns {string}
The output code.
		 */
