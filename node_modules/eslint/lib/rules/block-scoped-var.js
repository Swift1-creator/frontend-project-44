...
,
		...
		messages: {
			outOfScope:
				"'{{name}
}' declared on line {{definitionLine}} column {{definitionColumn}} is used outside of binding context.",
		}
,
	}
,
...
reference A reference to report.
		 * @param {eslint-scope.Definition}
definition A definition for which to report reference.
		 * @returns {void}
*/
...
// Defines a predicate to check whether or not a given reference is outside of valid scope.
			 ...
			 * @param {ASTNode}
reference node to examine
			 * @returns {boolean}
True is its outside the scope
			 * @private
			 */
