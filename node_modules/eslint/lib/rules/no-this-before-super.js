...
/**
		 ...
		 * @returns {boolean}
`true` if this is in a constructor.
		 */
...
segments The segments to search.
		 * @returns {boolean}
True if every segment has been called; false otherwise.
		 */
...
/**
		 ...
		 * @returns {boolean}
`true` if this is before `super()` is called.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node A node to set as invalid. This is one of
