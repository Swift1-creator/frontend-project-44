...
node The AST node
		 * @returns {boolean}
True if parens around node belong to parent node.
		 */
...
node The AST node
		 * @returns {boolean}
True if the node has a paren on each side.
		 */
...
node The AST node
		 * @returns {boolean}
True if two parens surround the node on each side.
		 */
