...
node A node to check.
		 * @returns {boolean}
True if the node is known to be side-effect free, false otherwise.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node A node to report. This is a FunctionExpression or
...
node A node to report. This is a FunctionExpression or
		 *      an ArrowFunctionExpression.
		 * @returns {boolean}
`true` if the node is the callee of `.bind()` method.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node A node to add. This node is a FunctionExpression
...
*/
		 ...
		 * @param {ASTNode}
node A node to remove. This node is a
...
/**
		 ...
		 * method.
		 * @param {ASTNode}
node A node to report. This node is an
