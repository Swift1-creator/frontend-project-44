...
node The node to check.
		 * @returns {boolean}
if the node is inside an ObjectPattern
		 * @private
		 */
...
/**
		 ...
		 * @param {ASTNode}
effectiveParent The effective parent node of the node to be reported
		 * @param {string}
name The identifier name of the identifier node
		 * @returns {boolean}
whether an error should be reported or not
		 */
