 ...
 * @param {ASTNode}
node A node to check. This node type is one of
 *   `Program`, `FunctionDeclaration`, `FunctionExpression`, and
 *   `ArrowFunctionExpression`.
 * @returns {boolean}
`true` if the node is a constructor.
 */
 ...
 * @returns {boolean}
`true` if the node can be a constructor.
 */
...
segment A code path segment to get.
		 * @returns {boolean}
The flag which shows `super()` is called in some paths
		 */
...
/**
		 ...
		 * @param {CodePathSegment}
segment A code path segment to check.
		 * @returns {boolean}
`true` if the segment has been seen.
		 */
...
segment A code path segment to get.
		 * @returns {boolean}
The flag which shows `super()` is called in all paths.
		 */
...
return {
			 ...
			 * @param {CodePath}
codePath A code path which was started.
			 * @param {ASTNode}
...
,
			 ...
			 * @param {CodePath}
codePath A code path which was ended.
			 * @param {ASTNode}
node The current node.
			 * @returns {void}
*/
...
// Reports if `super()` lacked.
			 ...
			 * @param {CodePathSegment}
segment A code path segment to initialize.
			 * @param {CodePathSegment}
node Node that starts the segment.
			 * @returns {void}
*/
...
,
			 ...
			 * looped.
			 * @param {CodePathSegment}
fromSegment The code path segment of the
			 *      end of a loop.
			 * @param {CodePathSegment}
toSegment A code path segment of the head
			 *      of a loop.
			 * @returns {void}
*/
...
,
			 ...
			 * @param {ASTNode}
node A CallExpression node to check.
			 * @returns {void}
*/
...
,
			 ...
			 * @param {ASTNode}
node A ReturnStatement node to check.
			 * @returns {void}
*/
