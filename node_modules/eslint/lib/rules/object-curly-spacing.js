...
option The option to exclude.
		 * @returns {boolean}
Whether or not the property is excluded.
		 */
...
//--------------------------------------------------------------------------
		 ...
		 * @param {ASTNode}
node The node to report in the event of an error.
		 * @param {Token}
token The token to use for the report.
		 * @returns {void}
*/
...
node The AST node to check.
		 * @param {Token}
first The first token to check (should be the opening brace)
		 * @param {Token}
second The second token to check (should be first after the opening brace)
		 * @param {Token}
penultimate The penultimate token to check (should be last before closing brace)
		 * @param {Token}
last The last token to check (should be closing brace)
		 * @returns {void}
*/
...
' token.
		 * @param {ASTNode}
node The node to get. This node is an
...
/**
		 ...
		 * @param {ASTNode}
node An ObjectExpression or ObjectPattern node to check.
		 * @returns {void}
*/
...
/**
		 ...
		 * @param {ASTNode}
node An ImportDeclaration node to check.
		 * @returns {void}
*/
...
/**
		 ...
		 * @param {ASTNode}
node An ExportNamedDeclaration node to check.
		 * @returns {void}
*/
