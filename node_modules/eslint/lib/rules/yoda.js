 ...
 * @returns {boolean}
Whether or not it is a comparison operator.
 */
...
operator The operator to check.
 * @returns {boolean}
Whether or not it is an equality operator.
 */
...
operator The operator to check.
 * @returns {boolean}
Whether the operator is used in range tests.
 */
...
node Node to test.
 * @returns {boolean}
True if the node is a negative number that looks like a
...
node Node to test
 * @returns {boolean}
True if the node should be treated as a single Literal node.
 */
...
,
		...
		messages: {
			expected:
				"Expected literal to be on the {{expectedSide}
} side of {{operator}}.",
		}
,
	}
,
	...
	create(context) {
		const [when, { exceptRange, onlyEquality }
] = context.options
		 ...
		 * @param {ASTNode}
node LogicalExpression node to test.
		 * @returns {boolean}
Whether node is a range test.
		 */
		function isRangeTest(node) {
			 ...
			 * @returns {boolean}
Whether node is a "between" range test.
			 */
...
/**
			 ...
			 * @returns {boolean}
Whether node is an "outside" range test.
			 */
...
/**
			 ...
			 * @returns {boolean}
Whether node is preceded immediately by an open
...
/**
		 ...
		 * @param {ASTNode}
node The BinaryExpression node
		 * @returns {string}
A string representation of the node with the sides and operator flipped
		 */
