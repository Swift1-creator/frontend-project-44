...
,
		...
		messages: {
			noShadow:
				"'{{name}
}' is already declared in the upper scope on line {{shadowedLine}} column {{shadowedColumn}}.",
			noShadowGlobal: "'{{name}
...
scope The scope to check
		 * @returns {boolean}
Whether the scope is a global augmentation
		 */
...
variable The variable to check
		 * @returns {boolean}
Whether the variable is a this parameter
		 */
...
variable The variable to check
		 * @param {Object}
shadowedVariable The shadowed variable
		 * @returns {boolean}
Whether it's a type/value shadow case to ignore
		 */
...
variable The variable to check
		 * @returns {boolean}
Whether it's a function type parameter shadow case to ignore
		 */
...
variable The variable to check
		 * @returns {boolean}
Whether the variable is a generic of a static method
		 */
...
variable The variable to check
		 * @returns {boolean}
Whether it's a static method generic shadowing class generic
		 */
...
/**
		 ...
		 * @param {ASTNode}
node An node to check.
		 * @param {number}
location A location to check.
		 * @returns {boolean}
...
/**
		 ...
		 * @param {ASTNode}
node a node to get.
		 * @param {(node: ASTNode) => boolean}
match a callback that checks whether or not the node verifies its condition or not.
...
variable a variable to check.
		 * @param {Object}
shadowedVariable a shadowedVariable to check.
		 * @returns {boolean}
...
;`.
		 * But it should report `var a = function(a) {}
;` or `var a = function() { function a() {} };`.
		 * @param {Object}
variable The variable to check.
		 * @param {Object}
scopeVar The scope variable to look for.
		 * @returns {boolean}
Whether or not the variable is inside initializer of scopeVar.
		 */
...
variable The variable to check
		 * @returns {boolean}
Whether the variable is declared in a definition file
		 */
...
variable The variable to check
		 * @returns {boolean}
Whether it's a duplicate enum name variable
		 */
...
shadowedVariable Shadowed variable
		 * @returns {boolean}
Whether it's an external declaration merging
		 */
