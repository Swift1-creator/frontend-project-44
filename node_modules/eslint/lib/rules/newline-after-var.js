...
node The node to get.
		 * @returns {Token}
The token to compare line to the next statement.
		 */
...
keyword keyword to test
		 * @returns {boolean}
True if `keyword` is a type of var
		 */
...
keyword keyword to test
		 * @returns {boolean}
True if `keyword` is a variant of for specifier
		 */
...
/**
		 ...
		 * @private
		 * @param {string}
nodeType nodeType to test
		 * @returns {boolean}
True if `nodeType` is an export specifier
		 */
...
node node to test
		 * @returns {boolean}
True if `node` is last of their parent block.
		 */
...
/**
		 ...
		 * @param {number}
commentStartLine The starting line of the group
		 * @returns {number}
The number of the last comment line of the group
		 */
...
token The token being checked
		 * @param {integer}
commentStartLine The line number on which the comment starts
		 * @returns {boolean}
True if `token` does not start immediately after a comment
		 */
...
/**
		 ...
		 * @private
		 * @param {ASTNode}
node `VariableDeclaration` node to test
		 * @returns {void}
*/
