...
,
		...
		messages: {
			notCamelCase: "Identifier '{{name}
}' is not in camel case.",
			notCamelCasePrivate: "#{{name}
} is not in camel case.",
		}
,
	}
...
node The node to check.
		 * @returns {boolean}
`true` if the node is an assignment target.
		 */
...
node The `Identifier` node to check.
		 * @returns {boolean}
`true` if the identifier uses the original name as-is.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node The `Identifier` node to report.
		 * @returns {void}
*/
