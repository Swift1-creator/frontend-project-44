...
reference The reference to check.
		 * @returns {boolean}
`true` if the reference is 'console'.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node The MemberExpression node to check.
		 * @returns {boolean}
`true` if the property name of the node is allowed.
		 */
...
reference The reference to check.
		 * @returns {boolean}
`true` if the reference is a member access which
...
/**
		 ...
		 * foo().
		 * @param {ASTNode}
node The ExpressionStatement node to check.
		 * @returns {boolean}
`true` if ASI will break after removing the ExpressionStatement
		 *      node.
		 */
...
/**
		 ...
		 *     syntax error.
		 *     if (a) { console.log(b) }
, removing console.log() here is acceptable.
		 *
...
node The MemberExpression node to check.
		 * @returns {boolean}
`true` if a suggestion can be provided for a node.
		 */
...
/**
		 ...
		 * @param {eslint-scope.Reference}
reference The reference to report.
		 * @returns {void}
*/
