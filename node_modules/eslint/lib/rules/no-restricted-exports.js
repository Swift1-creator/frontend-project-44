...
,
							restrictDefaultExports: {
								type: "object",
								properties: {
									// Allow/Disallow `export default foo; export default 42; export default function foo() {}
` format
									direct: {
										type: "boolean",
									}
,
									...
									// Allow/Disallow `export { foo as default }
;` declarations
									named: {
										type: "boolean",
									}
,
									...
									//  Allow/Disallow `export { default }
from "mod"; export { default as default } from "mod";` declarations
									defaultFrom: {
										type: "boolean",
									}
,
...
,
		...
		messages: {
			restrictedNamed:
				"'{{name}
}' is restricted from being used as an exported name.",
...
,
	...
	create(context) {
		 ...
		 * @param {ASTNode}
node exported `Identifier` or string `Literal` node to check.
		 * @returns {void}
*/
