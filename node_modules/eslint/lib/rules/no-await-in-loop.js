 ...
 * @returns {boolean}
`true` if it should stop traversing.
 */
...
node A node to check.
 * @param {ASTNode}
parent A parent node to check.
 * @returns {boolean}
`true` if the node is in loop.
 */
...
,
	create(context) {
		 ...
		 * @param {ASTNode}
awaitNode An AwaitExpression or ForOfStatement node to validate.
		 * @returns {void}
*/
