...
node node to check.
		 * @returns {boolean}
- true if the node is the finalizer of a TryStatement
		 */
...
node node to check.
		 * @param {string}
label label of the break or continue statement
		 * @returns {boolean}
- return whether the node is a finally block or a sentinel node
		 */
