...
,
	...
	create(context) {
		 ...
		 * @param {ASTNode}
callExpression A CallExpression node which is used to reject a Promise
		 * @returns {void}
*/
...
node A CallExpression node
		 * @returns {boolean}
`true` if the call is a Promise.reject() call
		 */
...
//----------------------------------------------------------------------
		...
		return {
			...
			/*
			 * Check for `new Promise((resolve, reject) => {}
)`, and check for reject() calls.
