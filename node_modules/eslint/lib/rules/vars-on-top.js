...
node any node
		 * @returns {boolean}
whether the given node represents a import declaration
		 */
...
node any node
		 * @returns {boolean}
`true` if the node is a variable declaration.
		 */
...
node The node to check
		 * @param {ASTNode[]}
statements collection of ASTNodes for the parent node block
		 * @returns {boolean}
True if var is on top otherwise false
		 */
