...
str String to test.
 * @returns {boolean}
True if str contains a line terminator.
 */
 ...
 * @returns {boolean}
True if the node is a single line.
 */
 ...
 * @param {ASTNode[]}
properties List of Property AST nodes.
 * @returns {boolean}
True if all properties is on a single line.
 */
 ...
 * @param {Object}
toOptions Object to be initialized
 * @param {Object}
fromOptions Object to be initialized from
 * @returns {Object}
The object with correctly initialized options and values
 */
...
function initOptions(toOptions, fromOptions) {
	if (typeof fromOptions.align === "object") {
		...
		toOptions.align = initOptionProperty({}
, fromOptions.align)
...
,
		...
		messages: {
			extraKey: "Extra space after {{computed}
}key '{{key}}'.",
			extraValue:
				"Extra space before value for {{computed}
}key '{{key}}'.",
			missingKey: "Missing space after {{computed}
}key '{{key}}'.",
			missingValue:
				"Missing space before value for {{computed}
}key '{{key}}'.",
		}
,
	}
...
, options),
		 ...
		 * @param {ASTNode}
property Property node to check.
		 * @returns {boolean}
Whether the property is a key-value property.
		 */
...
node The node to start looking from.
		 * @returns {ASTNode}
The last token before a colon punctuator.
		 */
...
node The node to start looking from.
		 * @returns {ASTNode}
The first token after a colon punctuator.
		 */
...
/**
		 ...
		 * @param {ASTNode}
lastMember The last Property known to be in the group.
		 * @param {ASTNode}
candidate The next Property that might be in the group.
		 * @returns {boolean}
True if the candidate property is part of the group.
		 */
...
/**
		 ...
		 * @param {ASTNode}
property Property node whose key to retrieve.
		 * @returns {string}
The property's key.
		 */
...
/**
		 ...
		 * side of the colon.
		 * @param {ASTNode}
property Key-value pair in an object literal.
		 * @param {string}
side Side being verified - either "key" or "value".
		 * @param {string}
whitespace Actual whitespace string.
		 * @param {number}
expected Expected whitespace length.
		 * @param {string}
mode Value of the mode as "strict" or "minimum"
		 * @returns {void}
*/
...
,
		 ...
		 * @param {ASTNode}
property Property of on object literal.
		 * @returns {number}
Width of the key.
		 */
...
/**
		 ...
		 * @param {ASTNode}
property Property node from an object literal.
		 * @returns {Object}
Whitespace before and after the property's colon.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node ObjectExpression node being evaluated.
		 * @returns {Array<ASTNode[]>}
Groups of property AST node lists.
		 */
...
// Conditionally include one space before or after colon
		 ...
		 * @param {ASTNode}
node Property node being evaluated.
		 * @param {Object}
lineOptions Configured singleLine or multiLine options
		 * @returns {void}
*/
