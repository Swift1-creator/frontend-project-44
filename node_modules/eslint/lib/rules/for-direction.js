...
/**
		 ...
		 * @param {ASTNode}
update UpdateExpression to check
		 * @param {number}
dir expected direction that could either be turned around or invalidated
		 * @returns {number}
return dir, the negated dir, or zero if the counter does not change or the direction is not clear
		 */
...
update UpdateExpression to check
		 * @param {string}
counter variable name to check
		 * @returns {number}
if add return 1, if sub return -1, if nochange, return 0
		 */
...
/**
		 ...
		 * @param {ASTNode}
update AssignmentExpression to check
		 * @param {string}
counter variable name to check
		 * @returns {number}
if add return 1, if sub return -1, if nochange, return 0
