...
class ScientificNotation {
	/** @type {string}
The digits of the coefficient. A decimal point is implied after the first digit. */
	coefficient
...
${this.coefficient.length > 1 ? `.${this.coefficient.slice(1)}` : ""}e${this.magnitude}`
	}
/* c8 ignore stop */
}
/**
 ...
 * @param {Node}
node the node literal being evaluated
 * @returns {boolean}
true if the node is a number literal
 */
 ...
 * @returns {string}
raw source code of the literal, without numeric separators
 */
 ...
 * @returns {boolean}
true if the node is in base ten
 */
 ...
 * @param {string}
numberAsString the string representation of the number
 * @returns {string}
the stripped string
 */
 ...
 * @param {string}
stringInteger the string representation of the integer being converted
 * @returns {ScientificNotation}
the object containing the integer's coefficient and order of magnitude
 */
 ...
 * @param {string}
stringFloat the string representation of the float being converted
 * @returns {ScientificNotation}
the object containing the float's coefficient and order of magnitude
 */
 ...
 * @param {string}
stringNumber the string representation of the base ten number to be converted
 * @param {boolean}
parseAsFloat if true, the coefficient will be always parsed as a float, regardless of whether a decimal point is present
 * @returns {ScientificNotation}
the object containing the number's coefficient and order of magnitude
 */
