...
,
		...
		messages: {
			globalNonLexicalBinding:
				"Unexpected {{kind}
} declaration in the global scope, wrap in an IIFE for a local variable, assign as global property for a global variable.",
			globalLexicalBinding:
				"Unexpected {{kind}
} declaration in the global scope, wrap in a block or in an IIFE.",
			globalVariableLeak:
...
,
	...
	create(context) {
		const [{ lexicalBindings: checkLexicalBindings }
] = context.options
...
kind Declaration kind, can be 'var', 'const', 'let', function or class.
		 * @returns {void}
*/
