...
value An option value to parse.
 * @returns {{multiline: boolean, minProperties: number, consistent: boolean}
 ...
 * @returns {boolean}
`true` if the option is node-specific, otherwise `false`
 */
 ...
 * Normalizes a given option value.
 * @param {string|Object|undefined}
options An option value to parse.
 * @returns {{
 ...
 * @param {Object}
options option specific to node type
 * @param {Token}
first First object property
 * @param {Token}
last Last object property
 * @returns {boolean}
`true` if node needs to be checked for missing line breaks
 */
...
,
	...
	create(context) {
		 ...
		 * @param {ASTNode}
node A node to check. This is an ObjectExpression, ObjectPattern, ImportDeclaration or ExportNamedDeclaration node.
		 * @returns {void}
*/
		function check(node) {
