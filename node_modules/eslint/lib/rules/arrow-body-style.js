...
token The token to check.
		 * @returns {boolean}
`true` if it changes semantics if `;` or `}` followed by the token are removed.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node first node after an opening parenthesis.
		 * @returns {Token}
The found closing parenthesis token.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node node is inside for loop
		 * @returns {boolean}
`true` if the node is inside of a for loop, else `false`
		 */
