 ...
 * @param {Object|string}
rawOptions The user-provided options.
 * @param {string}
which Either "line" or "block".
 * @returns {Object}
...
rawOptions The user-provided options.
 * @returns {Object}
An object with "Line" and "Block" keys and corresponding
 ...
 * @param {Object}
normalizedOptions The normalized rule options.
 * @returns {void}
*/
...
,
	...
	create(context) {
		 ...
		 * @param {ASTNode}
comment The comment node to check.
		 * @returns {boolean}
True if the comment is an inline comment, false
		 * otherwise.
		 */
...
comment The comment to check.
		 * @returns {boolean}
True if the comment follows a valid comment.
		 */
...
/**
		 ...
		 * @param {ASTNode}
comment The comment node to process.
		 * @param {Object}
options The options for checking this comment.
		 * @returns {boolean}
