 ...
 * @param {Array}
lines An array of each line of the file.
 * @returns {Array}
 ...
 * @param {Array}
comments An array of comment tokens.
 * @returns {Array}
An array of line numbers.
 */
...
, context.options[0])
		 ...
		 * @param {token}
token The comment token to check.
		 * @returns {boolean}
True if the comment is not alone.
		 */
...
/**
		 ...
		 * @param {ASTNode}
parent The Comment parent node.
		 * @param {string}
nodeType The parent type to check against.
		 * @returns {boolean}
True if the comment is inside nodeType.
		 */
...
The parent node that contains the given token.
		 */
...
nodeType The parent type to check against.
		 * @returns {boolean}
True if the comment is at parent start.
		 */
...
nodeType The parent type to check against.
		 * @returns {boolean}
True if the comment is at parent end.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at block start.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at block end.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at class start.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at class end.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at object start.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at object end.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at array start.
		 */
...
token The Comment token.
		 * @returns {boolean}
True if the comment is at array end.
		 */
...
token The Comment token.
		 * @param {Object}
opts Options to determine the newline.
		 * @param {boolean}
opts.after Should have a newline after this line.
		 * @param {boolean}
opts.before Should have a newline before this line.
		 * @returns {void}
*/
