 ...
 * @param {ASTNode}
node `ClassBody` node to check static initializers.
 * @param {number}
location A location to check.
 * @returns {boolean}
`true` if the location is inside of a class static initializer.
 */
 ...
 * @returns {boolean}
`true` if the scope is a class static initializer scope.
 */
 ...
 * @returns {boolean}
`true` if the reference is from a separate execution context.
 */
 ...
 * @returns {boolean}
`true` if the reference is evaluated during the initialization.
 */
...
const location = reference.identifier.range[1]
	...
	if (definition.type === "ClassName") {
		...
		return (
			 ...
			 * For example, `class C { static foo = C; static { bar = C; }
}` is valid.
			 */
 ...
 * @returns {boolean}
true if reference contains type query.
 */
 ...
 * @returns {boolean}
`true` if the reference is in a class decorator.
 */
...
reference The reference
		 * @returns {boolean}
`true` if the reference should be checked
		 */
