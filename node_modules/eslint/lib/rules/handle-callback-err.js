...
,
	...
	create(context) {
		 ...
		 * @param {string}
stringToCheck The string which should be checked.
		 * @returns {boolean}
Whether or not the string should be interpreted as a pattern.
		 */
...
/**
		 ...
		 * @param {string}
name The name which should be compared.
		 * @returns {boolean}
Whether or not the given name matches the configured error variable name.
		 */
...
scope The function scope.
		 * @returns {Array}
All parameters of the given scope.
		 */
