...
class LazyLoadingRuleMap extends Map {
	/**
	 * Initialize this map.
	 * @param {Array<[string, function(): Rule]>}
loaders The rule loaders.
	 */
	constructor(loaders) {
...
Rules.
	...
	*values() {
	...
	/**
	 * Iterate rules.
	 * @returns {IterableIterator<[string, Rule]>}
Rules.
	 */
	*entries() {
...
callbackFn The callback function.
	 * @param {any}
[thisArg] The object to pass to `this` of the callback function.
	 * @returns {void}
*/
