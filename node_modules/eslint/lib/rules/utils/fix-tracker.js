...
class FixTracker {
	 ...
	 * @param {ruleFixer}
fixer A ruleFixer instance.
	 * @param {SourceCode}
sourceCode A SourceCode object for the current code.
	 */
...
/**
	 ...
	 * @param {SourceRange}
range The range to retain.
	 * @returns {FixTracker}
The same RuleFixer, for chained calls.
	 */
	retainRange(range) {
...
/**
	 ...
	 * flow.
	 * @param {ASTNode}
node The node to use as a starting point.
	 * @returns {FixTracker}
The same RuleFixer, for chained calls.
	 */
...
/**
	 ...
	 * @param {ASTNode|Token}
nodeOrToken The node or token to use as a starting
...
/**
	 ...
	 * @param {SourceRange}
range The range to remove in the fix.
	 * @param {string}
