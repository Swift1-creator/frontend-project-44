...
,
	...
	create(context) {
		...
		const [{ decoration, location, terms: warningTerms }
] = context.options
		 ...
		 * @param {string}
term A term to convert to a RegExp
		 * @returns {RegExp}
The term converted to a RegExp
		 */
...
const warningRegExps = warningTerms.map(convertToRegExp)
		 ...
		 * @param {string}
comment The comment which is checked.
		 * @returns {Array}
All matched warning terms for this comment.
		 */
