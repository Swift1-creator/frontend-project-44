 ...
 * @returns {boolean}
`true` if the variable is shadowed.
 */
 ...
 * @returns {boolean}
`true` if the node is a MemberExpression of `parseInt`
 *      method.
 */
 ...
 * - undefined.
 * @param {ASTNode}
radix A node of radix to check.
 * @returns {boolean}
...
radix A node of radix to check.
 * @returns {boolean}
`true` if the node is the literal node of `10`.
 */
