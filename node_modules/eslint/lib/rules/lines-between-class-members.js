...
* When determining the desired layout of the code, we should treat this semicolon as
		 ...
		 * @param {ASTNode}
curNode Current class member node.
		 * @param {ASTNode}
nextNode Next class member node.
		 * @returns {Token}
The actual last token of `node`.
		 * @private
		 */
...
/**
		 ...
		 * @param {Token}
prevLastToken The last token in the previous member node.
		 * @param {Token}
nextFirstToken The first token in the next member node.
		 * @param {number}
maxLine The maximum number of allowed line difference between consecutive tokens.
		 * @returns {Token}
The last token among the consecutive tokens.
		 */
...
maxLine The maximum number of allowed line difference between consecutive tokens.
		 * @returns {Token}
The first token among the consecutive tokens.
		 */
...
/**
		 ...
		 * @param {Token}
before The token before.
		 * @param {Token}
after The token after.
		 * @returns {boolean}
True if there is a token or comment between two tokens.
		 */
...
/**
		 ...
		 * @param {ASTNode}
node The class member node to check.
		 * @param {string}
type The class member type to check.
		 * @returns {boolean}
`true` if the class member node matched the type.
		 * @private
		 */
...
/**
		 ...
		 * @param {ASTNode}
prevNode The previous node to match.
		 * @param {ASTNode}
nextNode The current node to match.
		 * @returns {string|null}
Padding type or `null` if no matches were found.
		 * @private
		 */
