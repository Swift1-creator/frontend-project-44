...
/**
		 ...
		 * @param {any}
option The option object or string value
		 * @param {Object}
defaults The defaults to use if options are not present
		 * @returns {Object}
the resolved object definition
		 */
...
token The token to check.
		 * @returns {boolean}
`true` if the token is a star token.
		 */
...
/**
		 ...
		 * @param {string}
kind Either "named", "anonymous", or "method"
		 * @param {string}
side Either "before" or "after".
		 * @param {Token}
leftToken `function` keyword token if side is "before", or
		 *     star token if side is "after".
		 * @param {Token}
rightToken Star token if side is "before", or identifier
...
,
		 ...
		 * @param {ASTNode}
node A function expression or declaration node.
		 * @returns {void}
*/
