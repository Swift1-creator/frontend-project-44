...
node the node
		 * @returns {boolean}
If the node is Boolean function or constructor
		 */
...
node the node
		 * @returns {boolean}
If the node is in one of the flagged contexts
		 */
...
/*
				 * Check last expression only in a sequence, i.e. if ((1, 2, Boolean(3))) {}
, since
...
node The node to check.
		 * @returns {boolean}
`true` if it has comments inside.
		 */
...
(Unreachable.)
		 * @returns {boolean}
`true` if the node needs to be parenthesized.
		 */
