...
,
	...
	create(context) {
		 ...
		 * @param {Token}
nodeOrToken The node or token to check.
		 * @returns {boolean}
...
/**
		 ...
		 * @param {Node|Token}
nodeOrToken A node or a token to be reported.
		 * @returns {void}
*/
...
/**
		 ...
		 * @param {Token}
firstToken The first token to check.
		 * @returns {void}
*/
...
return {
			 ...
			 * @param {Node}
node A EmptyStatement node to be reported.
			 * @returns {void}
*/
			EmptyStatement(node) {
			 ...
			 * @param {Node}
node A ClassBody node to check.
			 * @returns {void}
*/
			ClassBody(node) {
...
,
			 ...
			 * @param {Node}
node A MethodDefinition node of the start point.
			 * @returns {void}
*/
