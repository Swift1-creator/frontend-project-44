...
node The node to check.
		 * @returns {boolean}
True if the node has an else without an if.
		 * @private
		 */
...
test The test object to check.
		 * @returns {boolean}
True if the node is a negated unary expression.
		 * @private
		 */
...
test The test to check.
		 * @returns {boolean}
True if the node is a negated binary expression.
		 * @private
		 */
...
node The node to check.
		 * @returns {boolean}
True if the node has a negated if expression.
		 * @private
		 */
