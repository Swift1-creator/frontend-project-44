...
,
	...
	create(context) {
		 ...
		 * @param {ASTNode}
node The node with an extra or missing semicolon.
		 * @param {boolean}
missing True if the semicolon is missing.
		 * @returns {void}
*/
...
/**
		 ...
		 * @param {Token}
semiToken A semicolon token to check.
		 * @returns {boolean}
`true` if the next token is `;` or `}`.
		 */
...
/**
		 ...
		 * @param {Token}
lastToken A token to check.
		 * @returns {boolean}
`true` if the token is the closing brace of an arrow function.
		 */
...
node The node to check.
		 * @returns {boolean}
`true` if the node cannot have the semicolon
		 *      removed.
		 */
...
/**
		 ...
		 * @param {Node}
node A statement node to check.
		 * @returns {boolean}
`true` if the node is on the same line with the next token.
		 */
...
node A statement node to check.
		 * @returns {boolean}
`true` if the node can connect the next line.
		 */
...
/**
		 ...
		 * @param {Token}
token A token to check.
		 * @returns {boolean}
`true` if the token is one of `[`, `(`, `/`, `+`, `-`, ```, `++`, and `--`.
		 */
...
node A statement node to check.
		 * @returns {boolean}
whether the semicolon is unnecessary.
		 */
...
node The node to check.
		 * @returns {boolean}
whether the node is the last item in a one-liner block.
		 */
...
node The node to check.
		 * @returns {boolean}
whether the node is the last item in a one-liner ClassBody.
		 */
