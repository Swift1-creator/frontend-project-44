...
/**
		 ...
		 * @returns {Object}
`openers` and `closers` exception values
		 * @private
		 */
...
token The token to check
		 * @returns {boolean}
True if the token is one of the exceptions for the opener paren
		 */
...
token The token to check
		 * @returns {boolean}
True if the token is one of the exceptions for the closer paren
		 */
...
/**
		 ...
		 * @param {Object}
openingParenToken The paren token
		 * @param {Object}
tokenAfterOpeningParen The token after it
		 * @returns {boolean}
True if the opening paren is missing a required space
		 */
...
tokenAfterOpeningParen The token after it
		 * @returns {boolean}
True if the opening paren has a disallowed space
		 */
...
/**
		 ...
		 * @param {Object}
tokenBeforeClosingParen The token before the paren
		 * @param {Object}
closingParenToken The paren token
		 * @returns {boolean}
True if the closing paren is missing a required space
		 */
...
closingParenToken The paren token
		 * @returns {boolean}
True if the closing paren has a disallowed space
		 */
