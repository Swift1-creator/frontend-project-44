...
const sourceCode = context.sourceCode
		 ...
		 * @param {ASTNode}
node A BlockStatement or SwitchStatement node from which to get the open brace.
		 * @returns {Token}
The token of the open brace.
		 */
...
first The first token
		 * @param {Token}
second The second token
		 * @returns {boolean}
True if there is at least a line between the tokens
		 */
...
token The token to check.
		 * @returns {boolean}
Whether or not the token is followed by a blank line.
		 */
...
token The token to check
		 * @returns {boolean}
Whether or not the token is preceded by a blank line
		 */
...
(Unreachable)
		 * @returns {boolean}
True if the node should be padded, false otherwise.
		 */
		 ...
		 * @param {ASTNode}
node The AST node of a BlockStatement.
		 * @returns {void}
undefined.
		 */
