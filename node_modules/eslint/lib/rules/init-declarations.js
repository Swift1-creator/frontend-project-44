 ...
 * @param {ASTNode}
block A node to check.
 * @returns {boolean}
`true` when the node is a for loop.
 */
 ...
 * @param {ASTNode}
node A declarator node to check.
 * @returns {boolean}
`true` when the node has its initializer.
 */
...
,
		messages: {
			...
			notInitialized:
				"Variable '{{idName}
}' should not be initialized on declaration.",
		}
,
	}
,
