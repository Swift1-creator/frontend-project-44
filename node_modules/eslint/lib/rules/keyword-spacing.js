 ...
 * @returns {boolean}
`true` if the token is a "Template" token ends with "${".
 */
...
token A token to check.
 * @returns {boolean}
`true` if the token is a "Template" token starts with "}".
 */
...
,
	...
	create(context) {
		 ...
		 * @param {Token}
token A token to report.
		 * @param {RegExp}
pattern A pattern of the previous token to check.
		 * @returns {void}
*/
...
token A token to report.
		 * @param {RegExp}
pattern A pattern of the next token to check.
		 * @returns {void}
*/
...
options The option object to parse.
		 * @returns {Object}
...
token A token to report.
		 * @param {RegExp}
[pattern] Optional. A pattern of the previous
		 *      token to check.
		 * @returns {void}
*/
...
token A token to report.
		 * @param {RegExp}
[pattern] Optional. A pattern of the next
		 *      token to check.
		 * @returns {void}
*/
...
if (node.source) {
		 ...
		 * keyword is invalid.
		 * @param {ASTNode}
node An `ImportSpecifier` node to check.
		 * @returns {void}
*/
		 ...
		 * keyword is invalid.
		 * @param {ASTNode}
node An `ExportSpecifier` node to check.
		 * @returns {void}
*/
...
node A node to report.
		 * @throws {Error}
If unable to find token get, set, or async beside method name.
		 * @returns {void}
*/
