 ...
 * @param {Node}
node A node to get child node list.
 * @returns {Node[]|null}
The child node list.
 */
 ...
 * @returns {boolean}
`true` if the node is the last statement in the parent block.
 */
...
const nodeList = getChildren(node.parent)
	...
	return nodeList !== null && nodeList.at(-1) === node; // before `}
` or etc.
}
...
,
	...
	create(context) {
		 ...
		 * @param {Token}
semiToken The semicolon token to check.
		 * @param {"first"|"last"}
expected The expected location to check.
		 * @returns {void}
*/
