...
module.exports = function(repeat, t) {
	...
	t.test('invalid numeric count', function(st) {
		st['throws'](function() { repeat('abc', -Infinity); }
, RangeError)
		st['throws'](function() { repeat('abc', -1); }
, RangeError)
		st['throws'](function() { repeat('abc', +Infinity); }
, RangeError)
		st.end()
	...
	t.test('nullish this object', function(st) {
		st['throws'](function() { repeat(undefined); }
, TypeError)
		st['throws'](function() { repeat(undefined, 4); }
, TypeError)
		st['throws'](function() { repeat(null); }
, TypeError)
		st['throws'](function() { repeat(null, 4); }
, TypeError)
		st.end()
	}
)
	...
	t.test('cast this object', function(st) {
		...
		st.equal(repeat({ 'toString': function() { return 'abc'; }
}, 2), 'abcabc')
		st.end()
	}
)
