...
, 'key', 'value', false, nonBoolean); },
				...
				st['throws'](
					// @ts-expect-error
					function () { defineDataProperty({}
, 'key', 'value', false, false, nonBoolean); },
					TypeError,
...
st.ok(hasOwn(obj, 'existing'), 'has initial own property')
	...
	t.test('loose mode', { skip: !hasPropertyDescriptors }
, function (st) {
		var obj = { existing: 'existing property' }
...
,
	...
	t.test('non-normal data property, ES3', { skip: hasPropertyDescriptors }
, function (st) {
		/** @type {Record<PropertyKey, string>}
*/
		var obj = { existing: 'existing property' }
...
,
	...
	t.test('new non-normal data property, ES5+', { skip: !hasPropertyDescriptors }
, function (st) {
		/** @type {Record<PropertyKey, string>}
*/
		var obj = { existing: 'existing property' }
...
,
	...
	t.test('existing non-normal data property, ES5+', { skip: !hasPropertyDescriptors }
, function (st) {
...
,
	...
	t.test('frozen object, ES5+', { skip: !hasPropertyDescriptors }
, function (st) {
...
,
	...
	t.test('sealed object, ES5+', { skip: !hasPropertyDescriptors }
, function (st) {
...
,
	...
	t.test('nonextensible object, ES5+', { skip: !hasPropertyDescriptors }
, function (st) {
