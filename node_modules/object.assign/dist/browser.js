...
var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
'use strict'
...
module.exports = function callBoundIntrinsic(name, allowMissing) {
	...
	var intrinsic = /** @type {Parameters<typeof callBindBasic>[0][0]}
...
try {
		return $defineProperty([], 'length', { value: 1 }
).length !== 1
	}
catch (e) {
...
if (!Object.keys) {
	...
	var hasDontEnumBug = !isEnumerable.call({ toString: null }
, 'toString')
...
if (desc && !desc.writable) {
	...
	if (functionLengthIsConfigurable || functionLengthIsWritable || !loose) {
		if (hasDescriptors) {
			define(/** @type {Parameters<define>[0]}
