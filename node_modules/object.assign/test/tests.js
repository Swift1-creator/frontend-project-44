...
module.exports = function (assign, t) {
	t.test('error cases', function (st) {
		st['throws'](function () { assign(null); }
, TypeError, 'target must be an object')
		st['throws'](function () { assign(undefined); }
, TypeError, 'target must be an object')
		st['throws'](function () { assign(null, {}
); }, TypeError, 'target must be an object')
		st['throws'](function () { assign(undefined, {}
...
st.test('boolean', function (st2) {
	...
	t.test('non-object sources', function (st) {
		st.deepEqual(assign({ a: 1 }
, null, { b: 2 }), { a: 1, b: 2 }, 'ignores null source')
		st.deepEqual(assign({ a: 1 }
, { b: 2 }, undefined), { a: 1, b: 2 }, 'ignores undefined source')
		st.end()
	}
)
...
var returned = assign(target, source)
	...
	/* globals window */
	t.test('works with window.location', { skip: typeof window === 'undefined' }
, function (st) {
		var target = {}
...
var returned = assign(target, source1, source2)
		st.deepEqual(returned, { a: 1, b: 2, c: 3 }
...
var returned = assign(target, foo)
		st.equal(returned, target, 'returned object is the same reference as the target object')
		st.deepEqual(target, { a: 1, baz: true }
, 'returned object has only own properties from both')
		st.end()
	}
)

	t.test('includes enumerable symbols, after keys', { skip: !hasSymbols }
, function (st) {
		var visited = []
		var obj = {}
...
, obj)
	...
	t.test('does not fail when symbols are not present', { skip: !Object.isFrozen || Object.isFrozen(Object) }
, function (st) {
...
st.end()
	...
	t.test('checks enumerability and existence, in case of modification during [[Get]]', { skip: !Object.defineProperty }
, function (st) {
		var targetBvalue = {}
var targetCvalue = {}
