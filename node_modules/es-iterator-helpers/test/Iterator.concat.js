...
,
		...
		t.deepEqual(concat().next(), { value: undefined, done: true }
, 'no arguments -> empty iterator')
...
,
			...
			st.test('real iterators', { skip: !hasSymbols }
, function (s2t) {
			...
			st.test('test262: test/built-ins/Iterator/concat/arguments-checked-in-order', { skip: !hasPropertyDescriptors }
, function (s2t) {
				var getIterator = 0
...
var iterator = concat(iterable)
			...
			st.test('test262: test/built-ins/Iterator/concat/get-iterator-method-only-once', { skip: !hasPropertyDescriptors }
, function (s2t) {
				var iteratorGets = 0
				var iteratorCalls = 0
				var array = [1, 2, 3]
...
Object.defineProperty(
			...
			st.test('test262: test/built-ins/Iterator/concat/get-iterator-method-throws', { skip: !hasPropertyDescriptors }
, function (s2t) {
				var iterable = {}
Object.defineProperty(iterable, Symbol.iterator, {
				...
				s2t['throws'](function () { concat(iterable); }
, EvalError)
...
var iterator = concat(iterable)
				...
				s2t['throws'](function () { iterator.next(); }
, TypeError)
			...
			st.test('test262: test/built-ins/Iterator/concat/next-method-returns-throwing-done', { skip: !hasPropertyDescriptors }
, function (s2t) {
...
, EvalError)
			...
			st.test('test262: test/built-ins/Iterator/concat/next-method-returns-throwing-value-done', { skip: !hasPropertyDescriptors }
, function (s2t) {
...
var iterator = concat(iterable)
			...
			st.test('test262: test/built-ins/Iterator/concat/next-method-returns-throwing-value', { skip: !hasPropertyDescriptors }
, function (s2t) {
				var throwingIterator = {
					next: function () {
