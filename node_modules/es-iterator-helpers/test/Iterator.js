...
,
		...
		try {
			...
			SubIter = Function('Iter', 'return class SubIter extends Iter {}
;')(Iter)
			SubSubIter = Function('SubIter', 'return class SubSubIter extends SubIter {}
;')(SubIter)
		}
catch (e) { /**/ }

		t.test('class inheritance', { skip: !SubIter }
, function (st) {
			st.doesNotThrow(
...
, function (et) {
			...
			t.test('prototype descriptor', { skip: !defineProperties.supportsDescriptors }
, function (pt) {
