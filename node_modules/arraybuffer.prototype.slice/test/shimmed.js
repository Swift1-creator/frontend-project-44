...
test('shimmed', function (t) {
	t.test('ArrayBuffer support', { skip: typeof ArrayBuffer === 'undefined' }
, function (st) {
...
, function (s2t) {
		...
		st.test('enumerability', { skip: !defineProperties.supportsDescriptors }
, function (et) {
		...
		st.test('bad array/this value', { skip: !hasStrictMode }
, function (s2t) {
			/* eslint no-useless-call: 0 */
			s2t['throws'](function () { return method.call(undefined); }
, TypeError, 'undefined is not an object')
			s2t['throws'](function () { return method.call(null); }
, TypeError, 'null is not an object')
			s2t.end()
		}
)

		t.test('has the correct descriptor', { skip: !Object.getOwnPropertyDescriptor }
, function (s2t) {
