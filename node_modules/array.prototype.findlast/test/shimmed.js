...
())
	...
	t.test('bad array/this value', { skip: !supportsStrictMode }
, function (st) {
		st['throws'](function () { return Array.prototype.findLast.call(undefined, 'a'); }
, TypeError, 'undefined is not an object')
		st['throws'](function () { return Array.prototype.findLast.call(null, 'a'); }
, TypeError, 'null is not an object')
		st.end()
	}
)

	t.test('Symbol.unscopables', { skip: typeof Symbol !== 'function' || typeof Symbol.unscopables !== 'symbol' }
, function (st) {
