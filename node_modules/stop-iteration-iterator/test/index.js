...
test('stopIterationIterator', function (t) {
	...
	t.test('no StopIteration support', { skip: typeof StopIteration === 'object' }
, function (st) {
		st['throws'](
			// @ts-expect-error
...
,
	...
	t.test('StopIteration support', { skip: typeof StopIteration !== 'object' }
, function (st) {
		// eslint-disable-next-line no-extra-parens
		var s = /** @type {Set<number> & { iterator(): SetIterator<number>}
} */ (new Set([1, 2]))
...
// eslint-disable-next-line no-extra-parens
		var m = /** @type {Map<number, string> & { iterator(): MapIterator<[string, number]>}
} */ (new Map([[1, 'a'], [2, 'b']]))
		var mi = m.iterator()
