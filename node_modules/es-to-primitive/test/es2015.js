...
/** @typedef {{ toString?: unknown, valueOf?: unknown, [Symbol.toPrimitive]?: unknown }
} Coercible */
...
test('Symbols', { skip: !v.hasSymbols }
, function (t) {
...
test('Objects', function (t) {
	...
	t.equal(toPrimitive({}
), '[object Object]', '{} with no hint coerces to Object#toString')
	t.equal(toPrimitive({}
, Number), '[object Object]', '{} with hint Number coerces to Object#toString')
	t.equal(toPrimitive({}
, String), '[object Object]', '{} with hint String coerces to Object#toString')
	...
	t.test('Symbol.toPrimitive', { skip: !v.hasSymbols || !Symbol.toPrimitive }
, function (st) {
		/** @type {Coercible}
*/
