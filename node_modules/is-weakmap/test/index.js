...
test('Maps', { skip: typeof Map !== 'function' }
, function (t) {
	var m = new Map()
...
test('Sets', { skip: typeof Set !== 'function' }
, function (t) {
	var s = new Set()
...
test('WeakMaps', { skip: typeof WeakMap !== 'function' }
, function (t) {
	var wm = new WeakMap()
...
test('WeakSets', { skip: typeof WeakSet !== 'function' }
, function (t) {
	var ws = new WeakSet()
