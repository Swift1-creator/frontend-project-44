 ...
 * ```ts
 * import { fromFileUrl }
from "@std/path/posix/from-file-url"
 * import { assertEquals }
from "@std/assert"
 *
 ...
 */ function fromFileUrl(url) {
  url = assertArg$3(url)
  return decodeURIComponent(url.pathname.replace(/%(?![0-9A-Fa-f]{2}
)/g, "%25"))
}
// Copyright 2018-2025 the Deno authors. MIT license.
// Copyright the Browserify authors. MIT License.
 ...
 * ```ts
 * import { isAbsolute }
from "@std/path/posix/is-absolute"
 ...
 * ```ts
 * import { toFileUrl }
from "@std/path/posix/to-file-url"
 * import { assertEquals }
from "@std/assert"
 *
...
from "@std/path/posix/to-namespaced-path"
 * import { assertEquals }
from "@std/assert"
 *
 ...
 * ```ts
 * import { globToRegExp }
from "@std/path/posix/glob-to-regexp"
 * import { assertEquals }
from "@std/assert"
 *
...
from "@std/path/posix/normalize-glob"
 * import { assertEquals }
from "@std/assert"
 *
 ...
 * ```ts
 * import { joinGlobs }
from "@std/path/posix/join-globs"
 * import { assertEquals }
from "@std/assert"
 *
