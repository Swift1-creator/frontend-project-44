...
,
	...
	t.test('no symbols', { skip: typeof Symbol === 'function' }
, function (st) {
	...
	t.test('symbols, no unscopables', { skip: typeof Symbol !== 'function' || !!Symbol.unscopables }
, function (st) {
	...
	t.test('Symbol.unscopables', { skip: typeof Symbol !== 'function' || !Symbol.unscopables }
, function (st) {
		st.deepEqual(
