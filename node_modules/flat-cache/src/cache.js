...
,
   ...
   * @method loadFile
   * @param  {String}
pathToFile the path to the file containing the info for the cache
   */
...
,
   ...
   * as a JSON structure
   * @param [noPrune=false] {Boolean}
whether to remove from cache the non visited files
   * @method save
   */
...
,
   ...
   * @return {Boolean}
true or false if the file was successfully deleted
   */
...
the id of the cache, would also be used as the name of the file cache
   * @param cacheDir {String}
the directory where the cache file was written
   * @returns {Boolean}
true if the cache folder was deleted. False otherwise
   */
