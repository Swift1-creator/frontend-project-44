...
` object as second argument.
  ...
  // `start` and `end` properties in `{line, column}
` form (with
...
// Properties of the current token:
  ...
  // And, if locations are used, the {line, column}
object
 ...
 *
 * @param {RegExpValidationState}
state The state to validate RegExp.
 * @returns {void}
*/
...
var codePos = ++this.pos
    code = this.readHexChar(this.input.indexOf("}
", this.pos) - this.pos)
    ++this.pos
