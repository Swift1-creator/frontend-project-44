...
*/
    ...
    // @ts-expect-error
    t['throws'](function () { forEach(arr); }
, TypeError, 'undefined is not a function')
    // @ts-expect-error
    t['throws'](function () { forEach(arr, null); }
, TypeError, 'null is not a function')
    // @ts-expect-error
    t['throws'](function () { forEach(arr, ''); }
, TypeError, 'string is not a function')
    // @ts-expect-error
    t['throws'](function () { forEach(arr, /a/); }
, TypeError, 'regex is not a function')
    // @ts-expect-error
    t['throws'](function () { forEach(arr, true); }
, TypeError, 'true is not a function')
    // @ts-expect-error
    t['throws'](function () { forEach(arr, false); }
, TypeError, 'false is not a function')
    // @ts-expect-error
    t['throws'](function () { forEach(arr, NaN); }
, TypeError, 'NaN is not a function')
    // @ts-expect-error
    t['throws'](function () { forEach(arr, 42); }
, TypeError, '42 is not a function')

    t.doesNotThrow(function () { forEach(arr, function () {}
); }, 'function is a function')
    // @ts-expect-error TODO fixme
    t.doesNotThrow(function () { forEach(arr, setTimeout); }
, 'setTimeout is a function')

    /* eslint-env browser */
    if (typeof window !== 'undefined') {
        t.doesNotThrow(function () { forEach(arr, window.alert); }
, 'alert is a function')
    }
t.end()
}
