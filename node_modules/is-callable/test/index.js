...
test('Typed Arrays', { skip: typedArrayNames.length === 0 }
, function (st) {
...
test('Arrow functions', { skip: arrows.length === 0 }
, function (t) {
...
test('`async function`s', { skip: asyncs.length === 0 }
, function (t) {
...
test('proxies of functions', { skip: !proxy }
, function (t) {
...
test('DOM', function (t) {
	...
	t.test('document.all', { skip: typeof document !== 'object' }
, function (st) {
