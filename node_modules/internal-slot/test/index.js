...
,
	...
	forEach([null, undefined, true, false, 42, 0, {}
, [], function () {}, /a/g], function (nonString) {
		t['throws'](
			// @ts-expect-error
			function () { SLOT.assert({}
, nonString); },
			TypeError,
...
, '[[whatever]]'); },
	...
	var o = {}
SLOT.set(o, 'x')
	t.doesNotThrow(function () { SLOT.assert(o, 'x'); }
, 'existent slot noops')
	t['throws'](function () { SLOT.assert(o, 'y'); }
, 'thing with a slot throws on a nonexistent slot')
