 ...
 *
 * @param {ASTNode}
ASTnode The AST node being checked
 * @param {Object}
visitor Visitor Object for estraverse
 */
...
ASTNode The AST node being checked
 * @param {Context}
context The context of `ASTNode`.
 * @param {(returnValue: ASTNode, breakTraverse: () => void) => void}
onReturn
 ...
 * @param {Object}
context The node to check
 * @param {ASTNode}
node The node to check
 * @return {ASTNode}
the first node in the line
 */
...
node The node to check
 * @return {boolean}
true if it's the first node in its line
 */
...
node The node to check
 * @return {boolean}
true if it's a function-like expression
 */
 ...
 * @param {string}
string the identifier to strip
 * @returns {string}
*/
 ...
 * @param {Context}
context The AST node with the key.
 * @param {any}
node The AST node with the key.
...
node The AST node
 * @returns {boolean}
True if node is a `CallExpression`, false if not
 */
 ...
 *
 * @param {ASTNode}
node - potential TS node
 * @returns {ASTNode}
- unwrapped expression node
 */
