...
Maps the variable to its definition. `props.a.b` is stored as `['a', 'b']` */
...
name
     * @param {string[]}
allNames Example: `props.a.b` should be formatted as `['a', 'b']`
 ...
 * @param {string}
name The AST node being checked.
 * @returns {boolean}
True if the prop name matches
 */
 ...
 * @returns {boolean}
True if the component must be validated, false if not.
 */
 ...
 * @return {boolean}
true if we are in a class constructor, false if not
 */
...
checkAsyncSafeLifeCycles
 * @return {boolean}
True if the node is a lifecycle method
 */
...
checkAsyncSafeLifeCycles
 * @return {boolean}
True if the node is inside a lifecycle method
 */
...
context
 * @param {ASTNode}
node The AST node being marked.
 * @returns {boolean}
True if the prop has spread operator, false if not.
 */
...
context
 * @param {ASTNode}
node The AST node with the property.
 * @param {Object}
utils
 * @param {boolean}
checkAsyncSafeLifeCycles
 * @return {string|undefined}
the name of the property or undefined if not found
 */
...
ASTNodes are not handled by markPropTypesAsUsed`)
    }
