 ...
 * @param {ASTNode}
node The node to check. Must be an Identifier node.
 * @returns {boolean}
`true` if the node is a propTypes declaration, `false` if not
 */
 ...
 * @returns {boolean}
`true` if the node is a contextTypes declaration, `false` if not
 */
...
node The node to check.
 * @returns {boolean}
`true` if the node is a contextType declaration, `false` if not
 */
...
node The node to check.
 * @returns {boolean}
`true` if the node is a childContextTypes declaration, `false` if not
 */
...
node The node to check. Must be an Identifier node.
 * @returns {boolean}
`true` if the node is a defaultProps declaration, `false` if not
 */
 ...
 * @returns {boolean}
True if we are declaring a display name, false if not.
 */
 ...
 * @param {ASTNode}
propTypeExpression node to check. Must be a `PropTypes` MemberExpression.
 * @returns {boolean}
`true` if this PropType is required, `false` if not.
 */
 ...
 * @param {ASTNode}
node The node to get the type arguments from.
 * @returns {ASTNode}
The type arguments or type parameters of the node.
 */
 ...
 * @param {ASTNode}
node The node to get the super type arguments from.
 * @returns {ASTNode}
The super type arguments or parameters of the node.
 */
