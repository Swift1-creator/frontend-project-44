 ...
 *
 * @param {string}
propName the name of the proptype to check.
 * @returns {boolean}
true if the proptype is a callback.
 */
...
node the prop to check.
 * @returns {boolean}
true if the prop is PropTypes.shape.
 */
...
node the prop to check.
 * @returns {Array}
the properties of the PropTypes.shape node.
 */
 ...
 * @param {Context}
context The context of the two nodes.
 * @param {boolean=}
ignoreCase whether or not to ignore case when comparing the two elements.
 * @param {boolean=}
requiredFirst whether or not to sort required elements first.
 * @param {boolean=}
callbacksLast whether or not to sort callbacks after everything else.
 * @param {boolean=}
noSortAlphabetically whether or not to disable alphabetical sorting of the elements.
 * @returns {number}
the sort order of the two elements.
 */
 ...
 *
 * @param {Context}
context the second element to compare.
 * @param {Fixer}
fixer the first element to compare.
 * @param {Array}
declarations The context of the two nodes.
 * @param {boolean=}
ignoreCase whether or not to ignore case when comparing the two elements.
 * @param {boolean=}
requiredFirst whether or not to sort required elements first.
...
noSortAlphabetically whether or not to disable alphabetical sorting of the elements.
 * @param {boolean=}
sortShapeProp whether or not to sort propTypes defined in PropTypes.shape.
 * @param {boolean=}
checkTypes whether or not sorting of prop type definitions are checked.
...
if (sortShapeProp && isShapeProp(sortedAttr.value)) {
        ...
        const sortedAttrTextVal = checkTypes && !sortedAttrText.endsWith(separator) ? `${sortedAttrText}
${separator}` : sortedAttrText
        return `${acc.slice(0, commentnodeMap.get(attr).start)}
