...
Return null if the value could not be resolved, ASTNode otherwise.
   */
...
/**
   ...
   * @param   {ASTNode}
objectExpression ObjectExpression node.
   * @returns {Object|string}
Object representation of a defaultProp, to be consumed by
...
/**
   ...
   * @param   {Object}
component The component to mark.
   * @returns {void}
*/
...
/**
   ...
   * @param   {ASTNode}
component    The component to add the defaultProps to.
   * @param   {Object[]|'unresolved'}
defaultProps defaultProps to add to the component or the string "unresolved"
