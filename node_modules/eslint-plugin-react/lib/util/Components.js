...
/**
   ...
   *
   * @param {ASTNode}
node The AST node being added.
   * @param {number}
confidence Confidence in the component detection (0=banned, 1=maybe, 2=yes)
   * @returns {Object}
...
/**
   ...
   *
   * @param {ASTNode}
node The AST node being searched.
   * @returns {Object}
Component object, undefined if the component is not found or has confidence value of 0.
   */
  get(node) {
    const id = getId(node)
...
/**
   ...
   *
   * @param {ASTNode}
node The AST node being updated.
   * @param {Object}
props Additional properties to add to the component.
   */
  set(node, props) {
    const list = Lists.get(this)
...
/**
   ...
   *
   * @returns {Object}
The list of React named imports
   */
...
/**
   ...
   *
   * @param {ASTNode}
specifier The AST Node of the default React import
   * @returns {void}
*/
  addDefaultReactImport(specifier) {
    const info = ReactImports.get(this)
    ReactImports.set(this, Object.assign({}
, info, {
...
/**
   ...
   *
   * @param {ASTNode}
specifier The AST Node of a named React import
   * @returns {void}
*/
 ...
 * @param {{[_: string]: Function}
[]} rules the returned values for eslint rule.create(context)
 * @returns {{[_: string]: Function}
} merged rule
 */
...
variable The variable name to check
     * @returns {boolean}
True if createElement is destructured from the pragma
     */
...
node
     *
     * @returns {ASTNode}
component node, null if we are not in a component
     */
...
,
     ...
     *
     * @param {ASTNode}
node The AST node being checked (must be a MemberExpression).
     * @returns {ASTNode | null}
component node, null if we cannot find the component
     */
...
,
     ...
     *
     * @param {ASTNode}
node The AST node being searched. (expects CallExpression)
     * @param {('useCallback'|'useContext'|'useDebugValue'|'useEffect'|'useImperativeHandle'|'useLayoutEffect'|'useMemo'|'useReducer'|'useRef'|'useState')[]}
[expectedHookNames] React hook names to which search is limited.
     * @returns {boolean}
True if the node is a call to a React hook
     */
