 ...
 * @returns {boolean}
True if the variable was found, false if not.
 */
...
name The name of the variable to search.
 * @returns {Object}
Variable if the variable was found, null if not.
 */
...
Variable if the variable was found, undefined if not.
 */
...
Return null if the variable could not be found, ASTNode otherwise.
 */
...
variable
 * @returns {Object | undefined}
The latest variable definition or undefined.
 */
