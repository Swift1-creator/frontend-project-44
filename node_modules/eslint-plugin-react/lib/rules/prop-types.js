...
const ignored = configuration.ignore || []
     ...
     * @param {string}
name Name of the prop to check.
     * @returns {boolean}
True if the prop is ignored, false if not.
     */
...
/**
     ...
     * @param {Object}
declaredPropTypes Description of propTypes declared in the current component
     * @param {string[]}
keyList Dot separated name of the prop to check.
     * @returns {boolean}
True if the prop is declared, false if not.
     */
...
node The AST node being checked.
     * @param {string[]}
names List of names of the prop to check.
     * @returns {boolean}
True if the prop is declared, false if not.
     */
    function isDeclaredInComponent(node, names) {
      while (node) {
        ...
        const isDeclared = component && component.confidence >= 2
          && internalIsDeclaredInComponent(component.declaredPropTypes || {}
, names)
...
/**
     * @param {Object}
component The current component to process
     * @param {Array}
list The all components to process
     * @returns {boolean}
True if the component is nested False if not.
     */
