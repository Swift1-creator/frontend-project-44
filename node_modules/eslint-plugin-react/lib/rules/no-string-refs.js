...
node The AST node being checked.
     * @returns {boolean}
True if we are using refs, false if not.
     */
...
node The AST node being checked.
     * @returns {boolean}
True if we are using a ref attribute, false if not.
     */
...
node The AST node being checked.
     * @returns {boolean}
True if the node contains a string value, false if not.
     */
...
node The AST node being checked.
     * @returns {boolean}
True if the node contains a string value within a jsx expression, false if not.
     */
