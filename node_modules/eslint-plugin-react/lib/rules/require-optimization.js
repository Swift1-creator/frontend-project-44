...
node The AST node being checked.
     * @returns {boolean}
True if node is decorated with a PureRenderMixin, false if not.
     */
...
node The AST node being checked.
     * @returns {boolean}
True if node is decorated name with a custom decorated, false if not.
     */
...
node The AST node being checked.
     * @returns {boolean}
True if we are declaring a shouldComponentUpdate method, false if not.
     */
...
node The AST node being checked.
     * @returns {boolean}
True if we are declaring a PureRenderMixin method, false if not.
     */
...
node
     * @returns {boolean}
True if we are declaring function in class, false if not.
     */
