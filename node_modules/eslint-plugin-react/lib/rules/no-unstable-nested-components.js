 ...
 * @param {string}
parentName Name of the parent component, if known
 * @returns {string}
Error message with parent component name
 */
function generateErrorMessageWithParentName(parentName) {
  return `Do not define components during render. React will see a new component type on every render and destroy the entire subtree’s DOM nodes and state (https://reactjs.org/docs/reconciliation.html#elements-of-different-types). Instead, move this component definition out of the parent component${parentName ? ` “${parentName}
...
node The AST node
 * @param {Context}
context eslint context
 * @param {Function}
matcher Method used to match the parent
 * @returns {ASTNode}
The matching parent node, if any
 */
...
context eslint context
 * @returns {boolean}
True if node is a `createElement` call, false if not
 */
...
node The AST node
 * @returns {boolean}
True if node is a `ObjectExpression`, false if not
 */
...
node The AST node
 * @returns {boolean}
True if node is a `JSXExpressionContainer`, false if not
 */
...
node The AST node
 * @returns {boolean}
True if node is a `JSXAttribute` of `JSXExpressionContainer`, false if not
 */
...
node The AST node
 * @returns {boolean}
True if node is a `Property`, false if not
 */
...
context eslint context
 * @returns {boolean}
True if node is a `ReturnStatement` of a React hook, false if not
 */
...
context eslint context
 * @param {string}
propNamePattern a pattern to match render props against
 * @returns {boolean}
...
node The AST node
 * @param {string}
propNamePattern The pattern to match render props against
 * @returns {boolean}
 ...
 * @param {ASTNode}
node The AST node of the component
 * @returns {string}
...
,
  ...
  create: Components.detect((context, components, utils) => {
    ...
    const propNamePattern = (context.options[0] || {}
...
node The AST node being checked
     * @returns {boolean}
True if given node a function component declared inside class component, false if not
     */
...
node The AST node
     * @returns {boolean}
True if node is declare inside `createElement` call's props, false if not
     */
...
node The AST node being checked
     * @returns {boolean}
True if node is a component declared inside prop, false if not
     */
...
node The AST node being checked
     * @returns {boolean}
True if node is a stateless component returning non-JSX, false if not
     */
