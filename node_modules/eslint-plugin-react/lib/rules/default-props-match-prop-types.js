...
const messages = {
  requiredHasDefault: 'defaultProp "{{name}
}" defined for isRequired propType.',
  defaultHasNoType: 'defaultProp "{{name}
}" has no corresponding propTypes declaration.',
}
...
const allowRequiredDefaults = configuration.allowRequiredDefaults || false
     ...
     * @param  {Object[]}
propTypes    Array of propTypes to check.
     * @param  {Object}
