...
} is a React lifecycle method, and should not be an arrow function or in a class field. Use an instance method instead.',
}
...
${getText(context, body)}${nextComment.map(x => getText(context, x)).join('')}; }`
                  )
                )
              }
,
