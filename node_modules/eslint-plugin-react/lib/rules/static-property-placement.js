...
const messages = {
  notStaticClassProp: '\'{{name}
}\' should be declared as a static class property.',
  notGetterClassFunc: '\'{{name}
}\' should be declared as a static getter class function.',
  declareOutsideClass: '\'{{name}
}\' should be declared outside the class body.',
}
...
node
      * @returns {boolean}
True if we are declaring context in class, false if not.
     */
