...
const messages = {
  unsortedProps: '{{propA}
} should be placed {{position}} {{propB}}',
}
...
method - Method metadata.
     * @returns {Array}
The matching patterns indexes. Return [Infinity] if there is no match.
     */
...
/**
     ...
     * @param {Object}
propA - Mispositioned property.
     * @param {Object}
propB - Reference property.
     */
...
/**
     ...
     * @param {Array}
propertiesInfos Array containing all the properties metadata.
     * @param {Object}
propA First property name and metadata
     * @param {Object}
propB Second property name.
     * @returns {Object}
Object containing a correct true/false flag and the correct indexes for the two properties.
     */
     ...
     * @param {Array}
properties Array containing all the properties.
     */
