...
/**
 * @param {object}
rules - rules object mapping rule name to rule module
 * @returns {Record<string, SEVERITY_ERROR | 'error'>}
*/
function configureAsError(rules) {
  return fromEntries(Object.keys(rules).map(key => [`react/${key}
`, 2]))
}
...
const SEVERITY_ERROR = /** @type {2}
*/ (2)
const SEVERITY_OFF = /** @type {0}
*/ (0)
