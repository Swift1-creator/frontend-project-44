...
test('getSideChannelMap', { skip: typeof WeakMap !== 'function' && typeof Map !== 'function' }
, function (t) {
...
t.test('export', function (st) {
	...
	t.test('assert', function (st) {
		...
		var o = {}
channel.set(o, 'data')
		st.doesNotThrow(function () { channel.assert(o); }
...
st.equal(channel['delete']({}), false, 'nonexistent value yields false')
		...
		st.equal(channel['delete']({}
), false, 'nonexistent value still yields false')
...
test('getSideChannelMap, no WeakMaps and/or Maps', { skip: typeof WeakMap === 'function' || typeof Map === 'function' }
, function (t) {
