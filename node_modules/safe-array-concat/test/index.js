...
test('safe-array-concat', function (t) {
	...
	t.deepEqual(
		...
		safeConcat(/** @type {(string | number | number[])[]}
*/ ([1, 2]), [3, 4], 'foo', 5, 6, [[7]]),
		[1, 2, 3, 4, 'foo', 5, 6, [7]],
	...
	t.test('has Symbol.species', { skip: !species }
, function (st) {
		var speciesArr = [1, 2]
...
// @ts-expect-error ts(2538) TS can't type narrow from tape's `skip`
	...
	t.test('has isConcatSpreadable', { skip: !isConcatSpreadable }
, function (st) {
