...
test('errors', function (t) {
	...
	// @ts-expect-error
	t['throws'](function () { ToObject(null); }
, TypeError)
	// @ts-expect-error
	t['throws'](function () { ToObject(undefined); }
, TypeError)
	// @ts-expect-error
	t['throws'](function () { RequireObjectCoercible(null); }
, TypeError)
	// @ts-expect-error
	t['throws'](function () { RequireObjectCoercible(undefined); }
, TypeError)
