...
test('Functions', function (t) {
	t.notOk(isTypedArray(function () {}
), 'function is not typed array')
	t.end()
}
)

test('Generators', { skip: generators.length === 0 }
, function (t) {
...
test('Arrow functions', { skip: !arrowFn }
, function (t) {
...
test('@@toStringTag', { skip: !hasToStringTag }
, function (t) {
...
/** @typedef {Int8ArrayConstructor | Uint8ArrayConstructor | Uint8ClampedArrayConstructor | Int16ArrayConstructor | Uint16ArrayConstructor | Int32ArrayConstructor | Uint32ArrayConstructor | Float32ArrayConstructor | Float64ArrayConstructor | BigInt64ArrayConstructor | BigUint64ArrayConstructor}
