...
test('function', function (t) {
    t.plan(1)
    var obj = [1, 2, function f(n) { return n; }
, 4]
...
'; }
    var obj = [1, 2, f, 4]
    t.equal(inspect(obj), '[ 1, 2, [Function (anonymous)] { toString: [Function: toStr] }
, 4 ]')
}
)
...
test('arrow function', { skip: !arrow }
, function (t) {
...
test('truly nameless function', { skip: !arrow || !functionsHaveConfigurableNames }
, function (t) {
    function f() {}
