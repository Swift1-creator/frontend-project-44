...
'
    ...
    t.equal(inspect(obj, { indent: 2 }
), expectedSpaces, 'two')
    t.equal(inspect(obj, { indent: '\t' }
), expectedTabs, 'tabs')
}
)
...
'
    ...
    t.equal(inspect(new Map(), { indent: 2 }
), 'Map (0) {}', 'empty Map should show as empty (two)')
    t.equal(inspect(new Map(), { indent: '\t' }
...
'
    ...
    t.equal(inspect(nestedMap, { indent: 2 }
), expectedNestedSpaces, 'Map containing a Map should work (two)')
    t.equal(inspect(nestedMap, { indent: '\t' }
...
'
    ...
    t.equal(inspect(nestedSet, { indent: 2 }
), expectedNestedSpaces, 'Set containing a Set should work (two)')
    t.equal(inspect(nestedSet, { indent: '\t' }
