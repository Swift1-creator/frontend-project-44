...
test('Symbol.toStringTag', { skip: !hasToStringTag }
, function (t) {
    t.plan(4)
...
t.equal(inspect(obj), '{ a: 1 }', 'object, no Symbol.toStringTag')
    ...
    t.equal(inspect(obj), '{ a: 1, [Symbol(Symbol.toStringTag)]: \'foo\' }
', 'object with Symbol.toStringTag')

    t.test('null objects', { skip: 'toString' in { __proto__: null }
}, function (st) {
        st.plan(2)
...
st.equal(inspect(dict), '[Object: null prototype] { a: 1 }', 'null object with Symbol.toStringTag')
        ...
        st.equal(inspect(dict), '[Dict: null prototype] { a: 1, [Symbol(Symbol.toStringTag)]: \'Dict\' }
...
', 'instance, no toStringTag')
        ...
        st.equal(inspect(new C()), 'C [Class!] { a: 1 }
