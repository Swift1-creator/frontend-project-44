...
test('numericSeparator', function (t) {
    ...
    t.equal(inspect(1e3, { numericSeparator: false }
), '1000', '1000, numericSeparator false')
    t.equal(inspect(1e3, { numericSeparator: true }
    ...
    t.equal(inspect(1234.5678, { numericSeparator: true }
), '1_234.567_8', 'fractional numbers get separators')
    t.equal(inspect(1234.56789, { numericSeparator: true }
), '1_234.567_89', 'fractional numbers get separators')
    t.equal(inspect(1234.567891, { numericSeparator: true }
