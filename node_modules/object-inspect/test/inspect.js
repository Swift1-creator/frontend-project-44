...
, [] ]'
    ...
    t.equal(inspect(obj, { customInspect: true }
), stringResult)
    t.equal(inspect(obj, { customInspect: 'symbol' }
), falseResult)
    t.equal(inspect(obj, { customInspect: false }
), falseResult)
    t['throws'](
...
test('inspect custom symbol', { skip: !hasSymbols || !utilInspect || !utilInspect.custom }
, function (t) {
    t.plan(4)
...
obj[Symbol('test')] = 2
    ...
    if (typeof Symbol.iterator === 'symbol') {
        t.equal(inspect(obj), '{ a: 1, [Symbol(test)]: 2, [Symbol(Symbol.iterator)]: 3 }
', 'object with symbols')
        t.equal(inspect([obj, []]), '[ { a: 1, [Symbol(test)]: 2, [Symbol(Symbol.iterator)]: 3 }
...
|{ a: 1, \[Symbol\(Symbol.iterator\)\]: 3, \[Symbol\(test\)\]: 2 })$/,
...
test('inspect options', { skip: !utilInspect.custom }
, function (t) {
    var obj = {}
...
test('inspect URL', { skip: typeof URL === 'undefined' }
, function (t) {
    t.match(
