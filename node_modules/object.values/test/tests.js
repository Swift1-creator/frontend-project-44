...
var obj = { a: a, b: b, c: c }
	...
	t.deepEqual(values({ a: a, b: a, c: c }
), [a, a, c], 'duplicate values are included')
...
object[0] = 3
	...
	t.test('non-enumerable properties are omitted', { skip: !Object.defineProperty }
, function (st) {
		var object = { a: a, b: b }
...
F.prototype.a = a
	...
	t.test('Symbol properties are omitted', { skip: !hasSymbols }
, function (st) {
...
var enumSym = Symbol('enum')
	...
	t.test('not-yet-visited keys deleted on [[Get]] must not show up in output', { skip: !define.supportsDescriptors }
, function (st) {
		var o = { a: 1, b: 2, c: 3 }
Object.defineProperty(o, 'a', {
	...
	t.test('not-yet-visited keys made non-enumerable on [[Get]] must not show up in output', { skip: !define.supportsDescriptors }
, function (st) {
		var o = { a: 'A', b: 'B' }
Object.defineProperty(o, 'a', {
			get: function () {
