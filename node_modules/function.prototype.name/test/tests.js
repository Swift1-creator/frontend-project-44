...
st.equal(getName(foo), 'foo', 'foo has name "foo"')
	...
	t.test('arrow functions', { skip: arrows.length === 0 }
, function (st) {
	...
	t.test('generators', { skip: generators.length === 0 }
, function (st) {
	...
	t.test('asyncs', { skip: asyncs.length === 0 }
, function (st) {
	...
	t.test('Function.prototype.name', function (st) {
		st.equal(getName(function before() {}
), 'before', 'function prior to accessing Function.prototype has the right name')
		...
		st.equal(getName(function after() {}
), 'after', 'function after accessing Function.prototype has the right name')
	...
	t.test('DOM', function (st) {
		...
		st.test('document.all', { skip: typeof document !== 'object' }
, function (s2t) {
			s2t['throws'](
