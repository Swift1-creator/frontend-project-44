...
st.equal(getProto(proto), Object.prototype, 'proto: returns the [[Prototype]]')
			...
			// @ts-expect-error
				s2t['throws'](function () { return getProto(undefined); }
, TypeError, 'undefined is not an object')
				// @ts-expect-error
				s2t['throws'](function () { return getProto(null); }
, TypeError, 'null is not an object')
			...
			// @ts-expect-error
			st['throws'](function () { getProto(true); }
, 'throws for true')
			// @ts-expect-error
			st['throws'](function () { getProto(false); }
, 'throws for false')
			// @ts-expect-error
			st['throws'](function () { getProto(42); }
, 'throws for 42')
			// @ts-expect-error
			st['throws'](function () { getProto(NaN); }
, 'throws for NaN')
			// @ts-expect-error
			st['throws'](function () { getProto(0); }
, 'throws for +0')
			// @ts-expect-error
			st['throws'](function () { getProto(-0); }
, 'throws for -0')
			// @ts-expect-error
			st['throws'](function () { getProto(Infinity); }
, 'throws for ∞')
			// @ts-expect-error
			st['throws'](function () { getProto(-Infinity); }
, 'throws for -∞')
			// @ts-expect-error
			st['throws'](function () { getProto(''); }
, 'throws for empty string')
			// @ts-expect-error
			st['throws'](function () { getProto('foo'); }
, 'throws for non-empty string')
			st.equal(getProto(/a/g), RegExp.prototype)
			st.equal(getProto(new Date()), Date.prototype)
			st.equal(getProto(function () {}
), Function.prototype)
...
if ('toString' in nullObject) {
	...
	t.test('can not get', { skip: !!getProto }
, function (st) {
