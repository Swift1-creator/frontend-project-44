...
test('Iterator.prototype', function (t) {
	...
	t.test('Symbol.iterator', { skip: !hasSymbols }
, function (st) {
...
st.equal(
	...
	t.test('Array keys', { skip: typeof [].keys !== 'function' }
, function (st) {
	...
	t.test('Set keys', { skip: typeof Set !== 'function' || typeof Set.prototype.keys !== 'function' }
, function (st) {
