...
, function (et) {
	...
	t.test('Symbol.matchAll', { skip: !hasSymbols }
, function (st) {
		...
		st.test('Function name', { skip: !functionsHaveNames }
, function (s2t) {
...
s2t.end()
		...
		st.test('no symbol present', function (s2t) {
			s2t.doesNotThrow(function () { 'abc'.matchAll('b'); }
, 'does not throw on string input, with the symbol on regex prototype')
			...
			s2t['throws'](function () { 'abc'.matchAll('b'); }
