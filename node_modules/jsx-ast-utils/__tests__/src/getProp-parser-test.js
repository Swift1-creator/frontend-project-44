...
import { getOpeningElement, setParserName, fallbackToBabylon }
from '../helper'
...
const expression2 = {
  source: '<div {...{ id: `foo${bar}
baz` }} />', // eslint-disable-line no-template-curly-in-string
  target: '<div id={`foo${bar}
baz`} />', // eslint-disable-line no-template-curly-in-string
